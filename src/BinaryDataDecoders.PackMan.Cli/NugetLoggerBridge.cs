...
{
    public class NugetLoggerBridge : LoggerBase
    {
        private readonly ILogger<NugetLoggerBridge> _logger;

        public NugetLoggerBridge(
        ...
        public override void Log(ILogMessage message) =>
            _logger.Log(Convert(message.Level), Convert(message.Code), message, null, (s, e) => s.FormatWithCode());

        private EventId Convert(NuGetLogCode code) => new EventId((int)code, code.ToString());
