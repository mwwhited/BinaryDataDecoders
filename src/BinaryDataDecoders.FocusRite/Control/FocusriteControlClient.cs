...
namespace BinaryDataDecoders.FocusRite.Control
{
    /// <summary>
    /// https://github.com/raduvarga/Focusrite-Midi-Control/blob/master/Focusrite%20Midi%20Control/TCP/TCPListener.swift
    /// </summary>
    public class FocusriteControlClient
    {
        ...
        private string ClientConnectMessage { get => $@"<client-details hostname=""Focusrite Midi Control"" client-key=""{_clientKey}""/>"; }
        private readonly string KeepAlive = "<keep-alive/>";
