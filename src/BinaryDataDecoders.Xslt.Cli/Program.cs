            ...
            Parser.Default
                  ...
                  .WithParsed(o =>
                  {
                      new SandboxedTransformer(
                        ...
                        .TransformAll(
                          template: PathEx.FixUpPath(o.Template) ?? throw new ArgumentNullException(nameof(o.Template)),
                          input: PathEx.FixUpPath(o.Input) ?? throw new ArgumentNullException(nameof(o.Input)),
                          exclude: PathEx.FixUpPath(o.Exclude),
                          inputType: o.InputType,
                          output: PathEx.FixUpPath(o.Output) ?? throw new ArgumentNullException(nameof(o.Output)),
                          merge: o.Merge
                          );
                  });
        }
