namespace Test1.ROOT.CIMV2 {
    ...
    // An Early Bound class generated for the WMI class.Win32_USBController
    public class USBController : System.ComponentModel.Component {
        
        // Private property to hold the WMI namespace in which the class resides.
        private static string CreatedWmiNamespace = "ROOT\\CIMV2";
        
        // Private property to hold the name of WMI class which created this class.
        private static string CreatedClassName = "Win32_USBController";
        ...
        public USBController(string keyDeviceID) {
            this.InitializeObject(null, new System.Management.ManagementPath(USBController.ConstructPath(keyDeviceID)), null);
        }
        
        public USBController(System.Management.ManagementScope mgmtScope, string keyDeviceID) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(USBController.ConstructPath(keyDeviceID)), null);
        }
        
        public USBController(System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, path, getOptions);
        }
        
        public USBController(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path) {
            this.InitializeObject(mgmtScope, path, null);
        }
        
        public USBController(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public USBController(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public USBController(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public USBController(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("The DeviceID property contains a string uniquely identifying the USB controller f" +
        ...
        private static string ConstructPath(string keyDeviceID) {
            string strPath = "ROOT\\CIMV2:Win32_USBController";
        ...
        public static USBControllerCollection GetInstances() {
            return GetInstances(null, null, null);
        }
        
        public static USBControllerCollection GetInstances(string condition) {
            return GetInstances(null, condition, null);
        }
        
        public static USBControllerCollection GetInstances(System.String [] selectedProperties) {
            return GetInstances(null, null, selectedProperties);
        }
        
        public static USBControllerCollection GetInstances(string condition, System.String [] selectedProperties) {
            return GetInstances(null, condition, selectedProperties);
        }
        
        public static USBControllerCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            if ((mgmtScope == null)) {
            ...
            pathObj.ClassName = "Win32_USBController";
            ...
            return new USBControllerCollection(clsObject.GetInstances(enumOptions));
        }
        
        public static USBControllerCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition) {
            return GetInstances(mgmtScope, condition, null);
        }
        
        public static USBControllerCollection GetInstances(System.Management.ManagementScope mgmtScope, System.String [] selectedProperties) {
            return GetInstances(mgmtScope, null, selectedProperties);
        }
        
        public static USBControllerCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, System.String [] selectedProperties) {
            if ((mgmtScope == null)) {
                if ((statMgmtScope == null)) {
                    mgmtScope = new System.Management.ManagementScope();
                    mgmtScope.Path.NamespacePath = "root\\CIMV2";
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Win32_USBController", condition, selectedProperties));
            System.Management.EnumerationOptions enumOptions = new System.Management.EnumerationOptions();
            enumOptions.EnsureLocatable = true;
            ObjectSearcher.Options = enumOptions;
            return new USBControllerCollection(ObjectSearcher.Get());
        }
        
        [Browsable(true)]
        public static USBController CreateInstance() {
            ...
            return new USBController(tmpMgmtClass.CreateInstance());
        }
        ...
        public class USBControllerCollection : object, ICollection {
            
            private ManagementObjectCollection privColObj;
            
            public USBControllerCollection(ManagementObjectCollection objCollection) {
            ...
            public virtual void CopyTo(System.Array array, int index) {
                ...
                for (nCtr = 0; (nCtr < array.Length); nCtr = (nCtr + 1)) {
                    array.SetValue(new USBController(((System.Management.ManagementObject)(array.GetValue(nCtr)))), nCtr);
                }
            }
            
            public virtual System.Collections.IEnumerator GetEnumerator() {
                return new USBControllerEnumerator(privColObj.GetEnumerator());
            }
            
            public class USBControllerEnumerator : object, System.Collections.IEnumerator {
                
                private ManagementObjectCollection.ManagementObjectEnumerator privObjEnum;
                
                public USBControllerEnumerator(ManagementObjectCollection.ManagementObjectEnumerator objEnum) {
                    privObjEnum = objEnum;
                }
                
                public virtual object Current {
                    get {
                        return new USBController(((System.Management.ManagementObject)(privObjEnum.Current)));
                    }
                }
