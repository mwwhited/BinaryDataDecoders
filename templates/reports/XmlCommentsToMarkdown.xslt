...
<xsl:stylesheet
	...
	xmlns:o-path="clr:BinaryDataDecoders.ToolKit.Xml.Xsl.Extensions.PathExtensions, BinaryDataDecoders.ToolKit:out"
    ...
    xmlns:ex-env="clr:BinaryDataDecoders.ToolKit.Xml.Xsl.Extensions.EnvironmentExtensions, BinaryDataDecoders.ToolKit"
    xmlns:o-env="clr:BinaryDataDecoders.ToolKit.Xml.Xsl.Extensions.EnvironmentExtensions, BinaryDataDecoders.ToolKit:out"
	xmlns:ex-xsl="clr:BinaryDataDecoders.Xslt.Cli.XsltTransformer, BinaryDataDecoders.Xslt.Cli"
	xmlns:ex-str="clr:BinaryDataDecoders.ToolKit.Xml.Xsl.Extensions.StringExtensions, BinaryDataDecoders.ToolKit"
    xmlns:o-str="clr:BinaryDataDecoders.ToolKit.Xml.Xsl.Extensions.StringExtensions, BinaryDataDecoders.ToolKit:out"
