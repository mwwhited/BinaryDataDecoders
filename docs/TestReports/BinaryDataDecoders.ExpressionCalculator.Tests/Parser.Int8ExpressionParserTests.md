...
Variables: (A, 74), (B, 126), (C, -121), (D, 66), (E, -110), (F, 29), (G, -39), (H, 49)
Parsed Result: -119
...
Variables: (A, -43), (B, 97), (C, 55), (D, 12), (E, 77), (F, -36), (G, -3)
Parsed Result: -115
...
Variables: (A, 122), (B, 122), (C, -56), (D, -6)
Parsed Result: 6
Optimized Result: 6
```
...
Variables: (A, -115), (B, -83), (C, -62), (D, 23), (E, -113), (F, -80), (G, -55), (H, 52), (I, 65), (J, -107), (K, -3)
Parsed Result: 59
Optimized Result: 59
```
...
Variables: (A, 0), (B, 93), (C, 127), (D, 4), (E, 19)
Parsed Result: 19
Optimized Result: 19
```
...
Variables: (A, 30), (B, 103), (C, -44), (D, -87)
Parsed Result: 126
...
Variables: (A, -20), (B, -45), (C, -125), (D, 40), (E, -115)
Parsed Result: -91
Optimized Result: -91
```
...
As Parsed: (A * B * (C / D)) + E
As Optimized: A * B * C / D + E
Variables: (A, 13), (B, -41), (C, -85), (D, -69), (E, -58)
Parsed Result: -79
Optimized Result: -79
```
...
Variables: (A, 40), (B, 120), (C, -77), (D, 31), (E, 19), (F, 113)
Parsed Result: -9
Optimized Result: -9
```
...
Variables: (A, 62), (B, -75), (C, 120), (D, -109), (E, -104), (F, 86), (G, -63), (H, 63)
Parsed Result: 86
Optimized Result: 86
```
...
Variables: (A, 52), (B, -65), (C, -34), (D, 46), (E, 9)
Parsed Result: 5
Optimized Result: 5
```
...
As Parsed: (((A * B) * C) * D) + E
As Optimized: A * B * C * D + E
Variables: (A, 55), (B, -58), (C, 5), (D, -66), (E, -18)
Parsed Result: 10
Optimized Result: 10
```
...
Variables: (A, -125), (B, 20), (C, -44), (D, -46), (E, -2)
Parsed Result: 36
Optimized Result: 36
```
...
Variables: (A, 85), (B, -14), (C, -88), (D, 33), (E, -29), (F, 56)
Parsed Result: -26
Optimized Result: -26
```
...
Variables: (A, -5), (B, -35), (C, -87), (D, -57), (E, -93), (F, -4), (G, -56), (H, -76)
Parsed Result: -57
Optimized Result: -57
```
...
As Optimized: A / B * C * D * E * F + G
Variables: (A, 85), (B, -109), (C, 24), (D, 31), (E, -46), (F, -96), (G, -14)
Parsed Result: -14
Optimized Result: -14
```
...
Variables: (A, 31), (B, 66), (C, -40), (D, -12), (E, -5), (F, -95)
Parsed Result: -104
...
As Parsed: (A + B) * C + D
As Optimized: (A + B) * C + D
Variables: (A, 118), (B, -33), (C, 109), (D, -59)
Parsed Result: -10
Optimized Result: -10
```
...
As Parsed: ((A / (1 + (-1 * (B + C)))) * D) + E
As Optimized: A / (1 + (-(B + C))) * D + E
Variables: (A, 31), (B, -52), (C, 44), (D, -44), (E, -105)
Parsed Result: 19
Optimized Result: 19
```
...
Variables: (A, -47), (B, -86), (C, -110), (D, -72), (E, -59), (F, 86), (G, -43)
Parsed Result: 127
...
As Parsed: ((A - (B * C)) * D) + E
As Optimized: (A - (B * C)) * D + E
Variables: (A, 124), (B, -77), (C, 87), (D, -111), (E, -63)
Parsed Result: 88
Optimized Result: 88
```
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -17), (B, 102), (C, 114), (D, -50), (E, -85), (F, 107)
Parsed Result: 107
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, 24), (B, 1), (C, 9), (D, -42), (E, -70), (F, 69)
Parsed Result: -115
Optimized Result: -115
```
...
Variables: (A, 46), (B, 48), (C, 32), (D, -75), (E, -40), (F, 56), (G, 15), (H, 64)
Parsed Result: -96
Optimized Result: -96
```
...
Variables: (A, 47), (B, 80), (C, -30), (D, -23), (E, -66), (F, 123)
Parsed Result: -125
...
Variables: (A, 11), (B, -40), (C, 118), (D, 65), (E, -39), (F, 101), (G, -69), (H, 109)
Parsed Result: -36
Optimized Result: -36
```
...
As Parsed: (((A / B) * ((C * D) * E) * F) * G) + H
As Optimized: A / B * C * D * E * F * G + H
Variables: (A, -62), (B, 78), (C, -6), (D, -74), (E, -51), (F, 60), (G, 64), (H, -38)
Parsed Result: -38
Optimized Result: -38
```
...
Variables: (A, -37), (B, -108), (C, -56), (D, -61)
Parsed Result: -61
Optimized Result: -61
```
...
Variables: (A, -17), (B, -19), (C, 120), (D, -20), (E, -51), (F, 110), (G, 29), (H, -89), (I, 9), (J, -54), (K, -40)
Parsed Result: -42
Optimized Result: -42
```
...
Variables: (A, -101), (B, -4), (C, -15), (D, 78), (E, -113), (F, 46), (G, 4), (H, -104), (I, -86), (J, -29), (K, -102), (L, -55)
Parsed Result: 34
Optimized Result: 34
```
...
Variables: (A, -109), (B, -83), (C, -34), (D, -73), (E, -11), (F, 62), (G, 99), (H, -107), (I, -39), (J, 36)
Parsed Result: 23
Optimized Result: 23
```
...
Variables: (A, -75), (B, 10), (C, -26), (D, -98), (E, -86), (F, 60), (G, -104), (H, 115), (I, -4), (J, 32)
Parsed Result: -124
...
Variables: (A, 45), (B, 89), (C, 89), (D, 113), (E, 98), (F, 26), (G, -71), (H, -98), (I, 124)
Parsed Result: 127
Optimized Result: 127
```
...
Variables: (A, -94), (B, -69), (C, 110), (D, -85), (E, -33), (F, -33), (G, 126), (H, 127)
Parsed Result: -5
Optimized Result: -5
```
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 118), (B, 118), (C, -57), (D, -79), (E, -57), (F, 31)
Parsed Result: 31
Optimized Result: 31
```
...
As Optimized: (A + (-B)) / C * D * E * F + G
Variables: (A, -117), (B, -7), (C, 47), (D, -96), (E, -88), (F, 126), (G, 96)
Parsed Result: 96
Optimized Result: 96
```
...
Variables: (A, 89), (B, -102), (C, -28), (D, 48), (E, 75), (F, 58), (G, 113), (H, 44), (I, -54)
Parsed Result: -73
Optimized Result: -73
```
...
As Parsed: (((A - (B * C)) / D) * E) + F
As Optimized: (A - (B * C)) / D * E + F
Variables: (A, 14), (B, -71), (C, 114), (D, -65), (E, 35), (F, -116)
Parsed Result: -81
Optimized Result: -81
```
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -120), (B, -97), (C, -97), (D, -68), (E, -10), (F, 17)
Parsed Result: 105
...
Variables: (A, 18), (B, -86), (C, 90), (D, 82), (E, 83), (F, 31), (G, -66), (H, -128), (I, -119)
Parsed Result: 32
Optimized Result: 32
```
...
As Parsed: (A * B * C) + D
As Optimized: A * B * C + D
Variables: (A, 113), (B, 66), (C, -19), (D, 105)
Parsed Result: -29
Optimized Result: -29
```
...
As Optimized: ((A / B) + (-C)) * D * E * F * G + H
Variables: (A, 7), (B, 41), (C, 21), (D, -93), (E, -44), (F, 125), (G, -81), (H, -2)
Parsed Result: -70
Optimized Result: -70
```
...
Variables: (A, -105), (B, 75), (C, 33), (D, 28), (E, 34), (F, -12), (G, -66), (H, -4), (I, 55), (J, -110), (K, 61), (L, 72)
Parsed Result: 90
Optimized Result: 90
```
...
As Parsed: (((A / B) + (-1 * C)) * D * E * F) + G
As Optimized: ((A / B) + (-C)) * D * E * F + G
Variables: (A, 113), (B, -34), (C, -120), (D, -29), (E, -34), (F, 2), (G, -56)
Parsed Result: 12
Optimized Result: 12
```
...
As Parsed: ((A / B) * (((C * D) * E) * F)) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, -22), (B, 45), (C, -22), (D, 27), (E, -65), (F, -72), (G, -5)
Parsed Result: -5
Optimized Result: -5
```
...
As Parsed: ((A / B) * ((C * D) * E) * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 9), (B, -7), (C, 112), (D, 17), (E, -98), (F, 117), (G, 44)
Parsed Result: -116
...
Variables: (A, 35), (B, 79), (C, -124), (D, -29), (E, 124), (F, 23), (G, 4)
Parsed Result: 55
Optimized Result: 55
```
...
As Parsed: ((A - B) * C) + D
As Optimized: (A - B) * C + D
Variables: (A, 92), (B, -65), (C, 101), (D, -125)
Parsed Result: 116
Optimized Result: 116
```
...
Variables: (A, 72), (B, 89), (C, 118), (D, 70), (E, 105), (F, -75), (G, -88), (H, 67), (I, -55)
Parsed Result: 15
Optimized Result: 15
```
...
Variables: (A, -9), (B, -47), (C, 123), (D, 75), (E, 7), (F, -85), (G, 120), (H, -42)
Parsed Result: 68
Optimized Result: 68
```
...
As Optimized: (A + (-B)) / C * D * E * F * G + H
Variables: (A, -111), (B, 92), (C, -62), (D, 74), (E, -123), (F, 3), (G, -125), (H, -54)
Parsed Result: -54
Optimized Result: -54
```
...
As Parsed: ((A / B) * ((C * D) * E)) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -117), (B, -94), (C, -55), (D, 97), (E, 27), (F, -127)
Parsed Result: -44
Optimized Result: -44
```
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 79), (B, 17), (C, 64), (D, -66), (E, 58), (F, -106)
Parsed Result: -106
