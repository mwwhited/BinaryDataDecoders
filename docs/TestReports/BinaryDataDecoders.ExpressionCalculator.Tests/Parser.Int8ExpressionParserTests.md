...
Variables: (A, -38), (B, 76), (C, -26), (D, -89), (E, 0), (F, -32), (G, 104), (H, -103)
Parsed Result: 5
Optimized Result: 5
```
...
Variables: (A, -24), (B, -23), (C, -87), (D, 99), (E, -43), (F, 91), (G, -85)
Parsed Result: 99
Optimized Result: 99
```
...
Variables: (A, -23), (B, -36), (C, -64), (D, -101)
Parsed Result: -101
...
Variables: (A, -101), (B, -62), (C, -113), (D, -79), (E, -106), (F, -36), (G, 118), (H, 72), (I, 25), (J, -26), (K, -35)
Parsed Result: -4
Optimized Result: -4
```
...
Variables: (A, -77), (B, 27), (C, -27), (D, 117), (E, -30)
Parsed Result: 31
Optimized Result: 31
```
...
Variables: (A, -13), (B, -62), (C, 109), (D, 48)
Parsed Result: -36
Optimized Result: -36
```
...
Variables: (A, -48), (B, 100), (C, 113), (D, -18), (E, 87)
Parsed Result: -27
Optimized Result: -27
```
...
As Parsed: (A * B * (C / D)) + E
As Optimized: A * B * C / D + E
Variables: (A, 71), (B, -55), (C, -78), (D, 62), (E, 85)
Parsed Result: -106
...
Variables: (A, 16), (B, 10), (C, -20), (D, 99), (E, -44), (F, 4)
Parsed Result: 31
Optimized Result: 31
```
...
Variables: (A, 18), (B, 92), (C, 63), (D, 82), (E, 43), (F, 110), (G, 20), (H, 75)
Parsed Result: -79
Optimized Result: -79
```
...
Variables: (A, 95), (B, -103), (C, 21), (D, -20), (E, 26)
Parsed Result: 2
Optimized Result: 2
```
...
As Parsed: (((A * B) * C) * D) + E
As Optimized: A * B * C * D + E
Variables: (A, -39), (B, -42), (C, 91), (D, -61), (E, 8)
Parsed Result: 78
Optimized Result: 78
```
...
Variables: (A, 6), (B, -50), (C, 65), (D, 44), (E, 40)
Parsed Result: -20
Optimized Result: -20
```
...
Variables: (A, -80), (B, 21), (C, -36), (D, 110), (E, 1), (F, -66)
Parsed Result: 61
Optimized Result: 61
```
...
Variables: (A, -67), (B, 59), (C, 9), (D, 42), (E, 58), (F, 121), (G, 95), (H, 100)
Parsed Result: 120
...
As Optimized: A / B * C * D * E * F + G
Variables: (A, 95), (B, 41), (C, 111), (D, 57), (E, 10), (F, 29), (G, -127)
Parsed Result: 29
Optimized Result: 29
```
...
Variables: (A, -112), (B, -71), (C, 29), (D, 81), (E, -62), (F, 127)
Parsed Result: 82
Optimized Result: 82
```
...
As Parsed: ((A / (1 + (-1 * (B + C)))) * D) + E
As Optimized: A / (1 + (-(B + C))) * D + E
Variables: (A, -79), (B, -27), (C, 35), (D, -105), (E, 116)
Parsed Result: -15
Optimized Result: -15
```
...
Variables: (A, -22), (B, 84), (C, 87), (D, 55), (E, -76), (F, 3), (G, 71)
Parsed Result: 68
Optimized Result: 68
```
...
As Parsed: ((A - (B * C)) * D) + E
As Optimized: (A - (B * C)) * D + E
Variables: (A, -55), (B, -96), (C, -124), (D, 57), (E, 86)
Parsed Result: -105
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -126), (B, 103), (C, -15), (D, -73), (E, -52), (F, -40)
Parsed Result: 68
Optimized Result: 68
```
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, -117), (B, 71), (C, -10), (D, -87), (E, -110), (F, -1)
Parsed Result: 33
Optimized Result: 33
```
...
Variables: (A, -83), (B, -127), (C, 117), (D, -64), (E, -3), (F, 113), (G, 74), (H, -68)
Parsed Result: 60
Optimized Result: 60
```
...
Variables: (A, 34), (B, -39), (C, 32), (D, -100), (E, -59), (F, 76)
Parsed Result: 76
Optimized Result: 76
```
...
Variables: (A, 122), (B, 125), (C, -68), (D, 98), (E, 50), (F, 72), (G, 20), (H, -37)
Parsed Result: 91
Optimized Result: 91
```
...
As Parsed: (((A / B) * ((C * D) * E) * F) * G) + H
As Optimized: A / B * C * D * E * F * G + H
Variables: (A, 5), (B, -93), (C, -33), (D, -5), (E, 71), (F, 13), (G, 110), (H, 112)
Parsed Result: 112
Optimized Result: 112
```
...
Variables: (A, -45), (B, -100), (C, 15), (D, -55), (E, -72), (F, -63), (G, -31), (H, -50), (I, 71), (J, 38), (K, -35)
Parsed Result: -12
Optimized Result: -12
```
...
Variables: (A, -1), (B, -98), (C, 23), (D, -74), (E, -58), (F, 19), (G, -107), (H, -19), (I, 71), (J, 2), (K, 26), (L, 44)
Parsed Result: 80
Optimized Result: 80
```
...
Variables: (A, 83), (B, -7), (C, 110), (D, 118), (E, 70), (F, -122), (G, 113), (H, 57), (I, -79), (J, -24)
Parsed Result: 112
Optimized Result: 112
```
...
Variables: (A, -74), (B, 76), (C, 6), (D, 4), (E, -80), (F, -128), (G, 115), (H, -49), (I, 52), (J, 29)
Parsed Result: -112
Optimized Result: -112
```
...
Variables: (A, -92), (B, 27), (C, -83), (D, -98), (E, -37), (F, -46), (G, 61), (H, 19), (I, 25)
Parsed Result: -37
Optimized Result: -37
```
...
Variables: (A, -127), (B, 25), (C, -118), (D, 50), (E, -41), (F, -23), (G, -92), (H, -60)
Parsed Result: -32
Optimized Result: -32
```
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 4), (B, 16), (C, -97), (D, -101), (E, -12), (F, 29)
Parsed Result: 29
Optimized Result: 29
```
...
As Optimized: (A + (-B)) / C * D * E * F + G
Variables: (A, 121), (B, 47), (C, -71), (D, 126), (E, 83), (F, -105), (G, 106)
Parsed Result: -44
Optimized Result: -44
```
...
Variables: (A, 0), (B, -124), (C, -83), (D, 59), (E, -26), (F, 19), (G, -42), (H, -48), (I, 67)
Parsed Result: -68
Optimized Result: -68
```
...
As Parsed: (((A - (B * C)) / D) * E) + F
As Optimized: (A - (B * C)) / D * E + F
Variables: (A, -47), (B, -7), (C, 2), (D, 82), (E, 110), (F, -88)
Parsed Result: -88
Optimized Result: -88
```
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 51), (B, 106), (C, -93), (D, -3), (E, 80), (F, 100)
Parsed Result: 100
Optimized Result: 100
```
...
Variables: (A, -40), (B, -24), (C, 28), (D, -38), (E, 68), (F, -112), (G, 15), (H, -73), (I, 57)
Parsed Result: 72
Optimized Result: 72
```
...
As Parsed: (A * B * C) + D
As Optimized: A * B * C + D
Variables: (A, 81), (B, -117), (C, 19), (D, -107)
Parsed Result: 54
Optimized Result: 54
```
...
As Optimized: ((A / B) + (-C)) * D * E * F * G + H
Variables: (A, -17), (B, -126), (C, 84), (D, -25), (E, -123), (F, -68), (G, -19), (H, 90)
Parsed Result: -118
...
Variables: (A, -77), (B, 59), (C, 47), (D, -59), (E, -90), (F, -25), (G, 107), (H, 51), (I, -49), (J, -54), (K, -47), (L, -101)
Parsed Result: -106
Optimized Result: -106
```
...
As Parsed: (((A / B) + (-1 * C)) * D * E * F) + G
As Optimized: ((A / B) + (-C)) * D * E * F + G
Variables: (A, 122), (B, 86), (C, -94), (D, -48), (E, -106), (F, 108), (G, -57)
Parsed Result: 71
Optimized Result: 71
```
...
As Parsed: ((A / B) * (((C * D) * E) * F)) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, -55), (B, -43), (C, 39), (D, 18), (E, 125), (F, -27), (G, 10)
Parsed Result: 40
Optimized Result: 40
```
...
As Parsed: ((A / B) * ((C * D) * E) * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 123), (B, 76), (C, 89), (D, -39), (E, -60), (F, 119), (G, -12)
Parsed Result: 80
Optimized Result: 80
```
...
Variables: (A, 38), (B, 105), (C, -113), (D, 117), (E, 18), (F, 94), (G, -19)
Parsed Result: 6
Optimized Result: 6
```
...
Variables: (A, 117), (B, -58), (C, 107), (D, -105), (E, 4), (F, 56), (G, -21), (H, 20), (I, 1)
Parsed Result: 56
Optimized Result: 56
```
...
Variables: (A, -80), (B, -62), (C, -117), (D, 21), (E, 127), (F, 41), (G, -116), (H, 59)
Parsed Result: 2
Optimized Result: 2
```
...
As Optimized: (A + (-B)) / C * D * E * F * G + H
Variables: (A, -65), (B, 3), (C, 61), (D, -36), (E, 36), (F, -116), (G, -15), (H, 83)
Parsed Result: 19
Optimized Result: 19
```
...
As Parsed: ((A / B) * ((C * D) * E)) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 26), (B, -121), (C, -81), (D, 107), (E, 120), (F, 62)
Parsed Result: 62
Optimized Result: 62
```
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -27), (B, -122), (C, -80), (D, -78), (E, -98), (F, 56)
Parsed Result: 56
Optimized Result: 56
```
...
As Parsed: A * (B / C) + D
As Optimized: A * B / C + D
Variables: (A, 117), (B, 94), (C, 75), (D, 104)
Parsed Result: -35
Optimized Result: -35
```
