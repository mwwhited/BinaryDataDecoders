...
| :------------------- | ----------: | :--------------------------------------------------- |
| ✔ Passed             | 00:00:00.04 | `SimpleParserTests`                                  |
...
| Outcome              | Duration    | Test Name                                            |
| :------------------- | ----------: | :--------------------------------------------------- |
| ✔ Passed             | 00:00:00.08 | `VerifyOptimizerForComplexExpressions`               |
...
| ✔ Passed             | 00:00:00.00 | `Check Expressions "((A/(1+(-1*(B+C))))*D)+E"`       |
| ✔ Passed             | 00:00:00.00 | `Check Expressions "((A-(B*C))*D)+E"`                |
| ✔ Passed             | 00:00:00.01 | `Check Expressions "(((A+(-1*B))/C)*(D*E)*F)+G"`     |
| ✔ Passed             | 00:00:00.00 | `Check Expressions "((A/B)*((C*D)*E)*F)+G"`          |
...
| Outcome              | Duration    | Test Name                                            |
| :------------------- | ----------: | :--------------------------------------------------- |
| ✔ Passed             | 00:00:00.02 | `GetDistinctVariablesTests`                          |
| ✔ Passed             | 00:00:00.02 | `GetDistinctVariablesTests (A+B+C,A, B, C)`          |
...
| Outcome              | Duration    | Test Name                                            |
| :------------------- | ----------: | :--------------------------------------------------- |
| ✔ Passed             | 00:00:00.15 | `PoorlyFormedExpressions`                            |
| ✔ Passed             | 00:00:00.12 | `PoorlyFormedExpressions (-A!)`                      |
