...
| Result                   | Duration    | Test Name                                            |
| :----------------------- | ----------: | :--------------------------------------------------- |
|  ✔ Passed               | 00:00:00.14 | `VerifyOptimizerForComplexExpressions              ` |
|  ✔ Passed               | 00:00:00.04 | `Check Expressions "A"                             ` |
...
|  ✔ Passed               | 00:00:00.00 | `Check Expressions "(((A/B)+(-1*C))*D*E*F)+G"      ` |
|  ✔ Passed               | 00:00:00.00 | `Check Expressions "((A*B)+C)+(D*E*F)"             ` |
|  ✔ Passed               | 00:00:00.01 | `Check Expressions "((A/(1+(-1*(B+C))))*D)+E"      ` |
|  ✔ Passed               | 00:00:00.00 | `Check Expressions "((A-(B*C))*D)+E"               ` |
...
| Result                   | Duration    | Test Name                                            |
| :----------------------- | ----------: | :--------------------------------------------------- |
|  ✔ Passed               | 00:00:00.06 | `SimpleParserTests                                 ` |
...
|  ✔ Passed               | 00:00:00.02 | `Parse Complex Expression                          ` |
...
| Result                   | Duration    | Test Name                                            |
| :----------------------- | ----------: | :--------------------------------------------------- |
|  ✔ Passed               | 00:00:00.35 | `PoorlyFormedExpressions                           ` |
|  ✔ Passed               | 00:00:00.25 | `PoorlyFormedExpressions (-A!)                     ` |
