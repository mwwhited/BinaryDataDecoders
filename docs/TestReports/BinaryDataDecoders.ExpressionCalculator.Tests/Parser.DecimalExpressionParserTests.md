...
| :------------------- | ----------: | :--------------------------------------------------- |
| ✔ Passed             | 00:00:00.05 | `OptimizerTests`                                     |
...
| Outcome              | Duration    | Test Name                                            |
| :------------------- | ----------: | :--------------------------------------------------- |
| ✔ Passed             | 00:00:00.18 | `VerifyOptimizerForComplexExpressions`               |
| ✔ Passed             | 00:00:00.07 | `Check Expressions "A"`                              |
...
| ✔ Passed             | 00:00:00.01 | `Check Expressions "(A*((B+(-1*C))+((D*(B+(-1*C)))+E)+((F*G)+H))+((D*(B+(-1*C)))+E))"` |
...
| ✔ Passed             | 00:00:00.01 | `Check Expressions "(A*((((B+(-1*C))*D)+E)+((F*((G*H)+I))+J))+K)+(-1*((B+(-1*C))+(-1*(((B+(-1*C))*D)+E))))"` |
| ✔ Passed             | 00:00:00.00 | `Check Expressions "(A*((B+(-1*C))+((D*E)+F))+G)+(H*((B+(-1*C))+((D*E)+F)+(A*((B+(-1*C))+((D*E)+F))+G))+I)"` |
| ✔ Passed             | 00:00:00.01 | `Check Expressions "(A*((B+(-1*C))*D+E+(F*G)+H))+(-1*(B+(-1*C)+(-1*((B+(-1*C))*D+E))))+I*((B+(-1*C))*J+K+(F*G)+H+(A*((((B+(-1*C))*D)+E)+(F*G)+H))+(-1*(B+(-1*C)+(-1*((B+(-1*C))*D+E)))))+L"` |
...
| Outcome              | Duration    | Test Name                                            |
| :------------------- | ----------: | :--------------------------------------------------- |
| ✔ Passed             | 00:00:00.08 | `SimpleParserTests`                                  |
| ✔ Passed             | 00:00:00.02 | `Parse all operators test`                           |
| ✔ Passed             | 00:00:00.00 | `Simple test with variable`                          |
| ✔ Passed             | 00:00:00.00 | `Just variable`                                      |
| ✔ Passed             | 00:00:00.00 | `Just decimal value`                                 |
| ✔ Passed             | 00:00:00.01 | `Simple factorial`                                   |
| ✔ Passed             | 00:00:00.00 | `Negative factorial`                                 |
| ✔ Passed             | 00:00:00.03 | `Parse Complex Expression`                           |
...
| Outcome              | Duration    | Test Name                                            |
| :------------------- | ----------: | :--------------------------------------------------- |
| ✔ Passed             | 00:00:00.41 | `PoorlyFormedExpressions`                            |
| ✔ Passed             | 00:00:00.33 | `PoorlyFormedExpressions (-A!)`                      |
| ✔ Passed             | 00:00:00.04 | `PoorlyFormedExpressions (B/*1)`                     |
