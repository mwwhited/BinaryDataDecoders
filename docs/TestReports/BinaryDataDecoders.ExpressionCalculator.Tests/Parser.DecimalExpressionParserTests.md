...
| Result                   | Duration    | Test Name                                            |
| :----------------------- | ----------: | :--------------------------------------------------- |
|  ✔ Passed               | 00:00:00.04 | `GetDistinctVariablesTests                         ` |
|  ✔ Passed               | 00:00:00.04 | `GetDistinctVariablesTests (A+B+C,A, B, C)         ` |
...
| Result                   | Duration    | Test Name                                            |
| :----------------------- | ----------: | :--------------------------------------------------- |
|  ✔ Passed               | 00:00:00.09 | `VerifyOptimizerForComplexExpressions              ` |
...
|  ✔ Passed               | 00:00:00.00 | `Check Expressions "A*B"                           ` |
|  ✔ Passed               | 00:00:00.02 | `Check Expressions "((A+((-1*B)*(C/D)))*(E/C))+(-1*` |
...
| Result                   | Duration    | Test Name                                            |
| :----------------------- | ----------: | :--------------------------------------------------- |
|  ✔ Passed               | 00:00:00.23 | `PoorlyFormedExpressions                           ` |
|  ✔ Passed               | 00:00:00.18 | `PoorlyFormedExpressions (-A!)                     ` |
|  ✔ Passed               | 00:00:00.02 | `PoorlyFormedExpressions (B/*1)                    ` |
