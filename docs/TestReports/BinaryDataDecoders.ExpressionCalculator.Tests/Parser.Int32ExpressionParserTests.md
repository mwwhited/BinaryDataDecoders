...
Variables: (A, -774), (B, 1171), (C, 7452), (D, 7337), (E, -8425), (F, -6580), (G, 4988)
Parsed Result: 1880650478
Optimized Result: 1880650478
```
...
Variables: (A, -3103), (B, -6125), (C, 5515), (D, -254), (E, 1905), (F, 6499)
Parsed Result: -68465515
Optimized Result: -68465515
```
...
Variables: (A, -2357), (B, -5188), (C, 3434), (D, -7071)
Parsed Result: -4714
Optimized Result: -4714
```
...
Variables: (A, -2848), (B, -4549), (C, 2239), (D, -2136), (E, 2533), (F, -4724), (G, -5899)
Parsed Result: -782107563
Optimized Result: -782107563
```
...
Variables: (A, 9945), (B, -9040), (C, -3123)
Parsed Result: -89915868
Optimized Result: -89915868
```
...
Variables: (A, 709), (B, -8192), (C, 1626), (D, -1633), (E, -233), (F, -3165), (G, -9397), (H, -5914)
Parsed Result: -923334929
Optimized Result: -923334929
```
...
As Parsed: (A + B) * C + D
As Optimized: (A + B) * C + D
Variables: (A, 9230), (B, 2809), (C, -2407), (D, -6182)
Parsed Result: -28984055
Optimized Result: -28984055
```
...
Variables: (A, -4395), (B, -3837), (C, 7722), (D, 2490), (E, -1280), (F, 9760)
Parsed Result: -15218400
Optimized Result: -15218400
```
...
Variables: (A, 1954), (B, 3240), (C, -5499), (D, 2561), (E, 2192), (F, -8148), (G, -2170), (H, 5273), (I, -361), (J, 8697), (K, 9667), (L, 2226)
Parsed Result: -1635846805
Optimized Result: -1635846805
```
...
Variables: (A, -6821), (B, -2628), (C, -8964), (D, -5843), (E, 3571), (F, 9101), (G, 1753), (H, -2112), (I, 1769), (J, 506), (K, -1321), (L, -8292)
Parsed Result: -755947949
Optimized Result: -755947949
```
...
As Parsed: A * (B / C) + D
As Optimized: A * B / C + D
Variables: (A, -7512), (B, -255), (C, 8862), (D, -1431)
Parsed Result: -1431
Optimized Result: -1431
```
...
Variables: (A, -361), (B, -2166), (C, 7170), (D, -2844), (E, -8408), (F, 1383), (G, 9888), (H, -4940)
Parsed Result: -1514636077
Optimized Result: -1514636077
```
...
Variables: (A, 1084), (B, 5471), (C, -5024), (D, 3557)
Parsed Result: 3557
Optimized Result: 3557
```
...
As Parsed: A * B + C
As Optimized: A * B + C
Variables: (A, 3794), (B, 1018), (C, 1663)
Parsed Result: 3863955
Optimized Result: 3863955
```
...
Variables: (A, -7844), (B, -1944), (C, 8865), (D, 6107), (E, 1854), (F, -6083), (G, 9303), (H, -6127), (I, 4997)
Parsed Result: 1374860256
Optimized Result: 1374860256
```
...
As Parsed: (A * B)
As Optimized: A * B
Variables: (A, -8818), (B, -4785)
Parsed Result: 42194130
Optimized Result: 42194130
```
...
Variables: (A, 1428), (B, -9391), (C, 3887), (D, 9128), (E, -619)
Parsed Result: -2095880339
Optimized Result: -2095880339
```
...
As Parsed: (((A / B) * ((C * D) * E) * F) * G) + H
As Optimized: A / B * C * D * E * F * G + H
Variables: (A, 6432), (B, -1562), (C, 6921), (D, -9674), (E, 3865), (F, -678), (G, 5133), (H, -9951)
Parsed Result: -881579023
Optimized Result: -881579023
```
...
Variables: (A, -5752), (B, -7091), (C, -4059), (D, 5488), (E, -6365)
Parsed Result: -2084754781
Optimized Result: -2084754781
```
...
Variables: (A, -823), (B, -5861), (C, 8579), (D, -3979)
Parsed Result: 43211985
Optimized Result: 43211985
```
...
As Parsed: ((A / B) * C) + D
As Optimized: A / B * C + D
Variables: (A, 1753), (B, -4199), (C, -7813), (D, -5957)
Parsed Result: -5957
Optimized Result: -5957
```
...
Variables: (A, -8188), (B, -9857), (C, -9559), (D, -6519), (E, -4448), (F, 8762), (G, 1046)
Parsed Result: -7716
Optimized Result: -7716
```
...
Variables: (A, -1535), (B, 400), (C, -6110), (D, 1016), (E, -9004), (F, 4418), (G, -4214), (H, -5486)
Parsed Result: -1556287630
Optimized Result: -1556287630
```
...
As Optimized: A / B * C * D * E * F + G
Variables: (A, -6390), (B, -5069), (C, -1983), (D, 2190), (E, -4289), (F, -2914), (G, 6204)
Parsed Result: -1071778664
Optimized Result: -1071778664
```
...
Variables: (A, 4768), (B, -6114), (C, 5258), (D, -3671), (E, -8537), (F, -9691), (G, -8396), (H, 9874)
Parsed Result: 1130505831
Optimized Result: 1130505831
```
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 5445), (B, 8521), (C, -8371), (D, -8824), (E, -4887), (F, 5937)
Parsed Result: 5937
Optimized Result: 5937
```
...
Variables: (A, -2836), (B, -5515), (C, 8621), (D, -8158), (E, 9966), (F, 5833)
Parsed Result: -100792005
Optimized Result: -100792005
```
...
Variables: (A, -1701), (B, 9574), (C, -4699), (D, 3485), (E, -3927), (F, -9485), (G, 1847), (H, 6505)
Parsed Result: 559416565
Optimized Result: 559416565
```
...
As Parsed: (A * B) + C
As Optimized: A * B + C
Variables: (A, -3967), (B, 5611), (C, 7395)
Parsed Result: -22251442
Optimized Result: -22251442
```
...
As Parsed: ((A - B) * C) + D
As Optimized: (A - B) * C + D
Variables: (A, 7785), (B, 1458), (C, 3287), (D, 8036)
Parsed Result: 20804885
Optimized Result: 20804885
```
...
Variables: (A, -868), (B, -2497), (C, 7627), (D, 2091), (E, -4497), (F, -8958), (G, -5569), (H, -4731), (I, 3990)
Parsed Result: -261194345
Optimized Result: -261194345
```
...
As Parsed: (((A * B) + C) * D) + E
As Optimized: ((A * B) + C) * D + E
Variables: (A, -6505), (B, 6348), (C, 1220), (D, 2085), (E, -2998)
Parsed Result: -195561278
Optimized Result: -195561278
```
...
Variables: (A, -1736), (B, -1030), (C, -8951), (D, -4644), (E, -2146), (F, -1085), (G, -2964), (H, -7166)
Parsed Result: -1887811214
Optimized Result: -1887811214
```
...
As Parsed: (A * B * C) + D
As Optimized: A * B * C + D
Variables: (A, 6817), (B, 9842), (C, 6816), (D, -8528)
Parsed Result: 2038759920
Optimized Result: 2038759920
```
...
As Optimized: (A + (-B)) / C * D * E * F * G + H
Variables: (A, -3581), (B, -7364), (C, -1264), (D, -2943), (E, -7151), (F, -2175), (G, 3990), (H, 6623)
Parsed Result: 279988211
Optimized Result: 279988211
```
...
As Parsed: ((A / B) * ((C * D) * E)) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -8426), (B, 3657), (C, 4692), (D, -6128), (E, 8381), (F, -8239)
Parsed Result: 914333521
Optimized Result: 914333521
```
...
As Parsed: A + B
As Optimized: A + B
Variables: (A, -6454), (B, -7180)
Parsed Result: -13634
Optimized Result: -13634
```
...
As Parsed: ((A * B) * C) + D
As Optimized: A * B * C + D
Variables: (A, 1542), (B, -6403), (C, 8173), (D, 3122)
Parsed Result: 908871048
Optimized Result: 908871048
```
...
Variables: (A, 9315), (B, -561), (C, -7369), (D, 2374), (E, 5078), (F, -6835), (G, -4484), (H, 69), (I, 2837), (J, 6634)
Parsed Result: -781996390
Optimized Result: -781996390
```
...
As Parsed: ((A / (1 + (-1 * (B + C)))) * D) + E
As Optimized: A / (1 + (-(B + C))) * D + E
Variables: (A, -6376), (B, -6216), (C, 3766), (D, -6152), (E, 4308)
Parsed Result: 16612
Optimized Result: 16612
```
...
Variables: (A, -5758), (B, -1412), (C, 1025), (D, -9662), (E, -6963)
Parsed Result: 21767102
Optimized Result: 21767102
```
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 7357), (B, 548), (C, -3444), (D, -1102), (E, 4135), (F, 2235)
Parsed Result: -2142721533
Optimized Result: -2142721533
```
...
As Optimized: (A + (-B)) / C * D * E * F + G
Variables: (A, -3379), (B, 1645), (C, -3510), (D, -8961), (E, 7351), (F, -6794), (G, -5349)
Parsed Result: 859876801
Optimized Result: 859876801
```
...
As Optimized: ((A / B) + (-C)) * D * E * F * G + H
Variables: (A, 5482), (B, -8116), (C, 3577), (D, -4788), (E, 2536), (F, -3532), (G, -8720), (H, 2330)
Parsed Result: 724640026
Optimized Result: 724640026
```
...
Variables: (A, -6394), (B, 2539), (C, 5925), (D, -9020), (E, 8135), (F, 205), (G, -541), (H, -4349), (I, 6454)
Parsed Result: -1865122567
Optimized Result: -1865122567
```
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -5026), (B, -2091), (C, -2764), (D, 1089), (E, -2893), (F, -202)
Parsed Result: 235967470
Optimized Result: 235967470
```
...
Variables: (A, 4155), (B, -6798), (C, 8901), (D, 6336), (E, -3690)
Parsed Result: -1949338660
Optimized Result: -1949338660
```
...
As Parsed: (A / B) - (C + D + E + F)
As Optimized: A / B - C + D + E + F
Variables: (A, -1582), (B, -9383), (C, -7268), (D, -8208), (E, -7000), (F, 1190)
Parsed Result: 21286
Optimized Result: 21286
```
...
Variables: (A, 925), (B, 485), (C, 6096), (D, 7698), (E, -2781), (F, 1789), (G, -4969), (H, 9439), (I, 1903)
Parsed Result: -1009323513
Optimized Result: -1009323513
```
...
As Parsed: (A * B * (C / D)) + E
As Optimized: A * B * C / D + E
Variables: (A, -1015), (B, -6128), (C, 9237), (D, -3550), (E, 6767)
Parsed Result: -12433073
Optimized Result: -12433073
```
...
As Parsed: ((A / B) * (((C * D) * E) * F)) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 6005), (B, 4107), (C, -7009), (D, -6006), (E, -9345), (F, 1629), (G, 8298)
Parsed Result: -2140081588
Optimized Result: -2140081588
```
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 5324), (B, 9148), (C, 9752), (D, 390), (E, 3677), (F, 3598)
Parsed Result: 459282960
Optimized Result: 459282960
```
...
As Parsed: A * B
As Optimized: A * B
Variables: (A, 6538), (B, -6017)
Parsed Result: -39339146
Optimized Result: -39339146
```
...
As Parsed: ((A - (B * C)) * D) + E
As Optimized: (A - (B * C)) * D + E
Variables: (A, -2954), (B, -2902), (C, 6374), (D, -4225), (E, 1782)
Parsed Result: -829401540
Optimized Result: -829401540
```
...
Variables: (A, -7997), (B, 9797), (C, 9624), (D, -807), (E, -3384), (F, -4918), (G, 1029), (H, 4470), (I, 7622), (J, 3498), (K, -4087)
Parsed Result: 487451302
Optimized Result: 487451302
```
...
As Parsed: (((A / B) * C * D) * E * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, -1764), (B, 3920), (C, 8769), (D, 3167), (E, -1549), (F, 3373), (G, 4109)
Parsed Result: 4109
Optimized Result: 4109
```
...
Variables: (A, -7398), (B, -5996), (C, 5543), (D, -7142), (E, 4715), (F, -215), (G, 7162), (H, 6387), (I, 4864), (J, 4211), (K, -5257)
Parsed Result: 2080115111
Optimized Result: 2080115111
```
...
As Parsed: (((A / B) + (-1 * C)) * (D * E) * F) + G
As Optimized: ((A / B) + (-C)) * D * E * F + G
Variables: (A, 3620), (B, -8533), (C, -1429), (D, -1883), (E, -827), (F, -139), (G, 5917)
Parsed Result: -78685842
Optimized Result: -78685842
```
...
Variables: (A, 5364), (B, -394), (C, 7297), (D, 6052), (E, -4298), (F, 6447), (G, 3389), (H, -3136)
Parsed Result: -781597053
Optimized Result: -781597053
```
...
Variables: (A, 9865), (B, -6465), (C, -1273), (D, -5872), (E, -3133), (F, -6059), (G, -7876), (H, 6448), (I, -5009), (J, -7919)
Parsed Result: 1386276615
Optimized Result: 1386276615
```
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, -2370), (B, -4009), (C, 7310), (D, 5524), (E, 308), (F, -1816)
Parsed Result: 1214748064
Optimized Result: 1214748064
```
...
Variables: (A, -2298), (B, -1391), (C, 7265), (D, -7147), (E, -5996), (F, 2693)
Parsed Result: -8469655
Optimized Result: -8469655
```
