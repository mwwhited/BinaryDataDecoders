...
Variables: (A, -736), (B, 1456), (C, -8158), (D, -2246), (E, -2770), (F, -5725), (G, -7171)
Parsed Result: 1355307251
Optimized Result: 1355307251
```
...
Variables: (A, -7938), (B, 2007), (C, -5481), (D, -6668), (E, -7601), (F, -7447)
Parsed Result: 77575227
Optimized Result: 77575227
```
...
Variables: (A, -8332), (B, 6977), (C, 6930), (D, 9841)
Parsed Result: 1509
Optimized Result: 1509
```
...
Variables: (A, 2030), (B, -275), (C, 2776), (D, -2946), (E, -8130), (F, 2224), (G, -4308)
Parsed Result: -1207787028
Optimized Result: -1207787028
```
...
Variables: (A, 8469), (B, -760), (C, 8701)
Parsed Result: -6436208
Optimized Result: -6436208
```
...
Variables: (A, 4207), (B, 4963), (C, 9891), (D, -86), (E, 8439), (F, -7235), (G, -9413), (H, 7599)
Parsed Result: 419071497
Optimized Result: 419071497
```
...
As Parsed: (A + B) * C + D
As Optimized: (A + B) * C + D
Variables: (A, 2222), (B, 1893), (C, 6170), (D, 3571)
Parsed Result: 25393121
Optimized Result: 25393121
```
...
Variables: (A, -2910), (B, -6474), (C, 9389), (D, 5147), (E, -2352), (F, 5908)
Parsed Result: -27768860
Optimized Result: -27768860
```
...
Variables: (A, 4402), (B, -9151), (C, 105), (D, -1068), (E, 6145), (F, -5456), (G, 4227), (H, 2088), (I, 6235), (J, 8505), (K, -1183), (L, 5646)
Parsed Result: 164729709
Optimized Result: 164729709
```
...
Variables: (A, -9138), (B, 8980), (C, 928), (D, -5681), (E, 96), (F, 6012), (G, -9170), (H, 8486), (I, 4566), (J, -1208), (K, 5690), (L, 1086)
Parsed Result: 656214885
Optimized Result: 656214885
```
...
As Parsed: A * (B / C) + D
As Optimized: A * B / C + D
Variables: (A, -9438), (B, -5661), (C, 4832), (D, -9237)
Parsed Result: 201
Optimized Result: 201
```
...
Variables: (A, 7918), (B, -7925), (C, 6326), (D, -7157), (E, 1458), (F, -759), (G, 4478), (H, 9156)
Parsed Result: -1235483683
Optimized Result: -1235483683
```
...
Variables: (A, -8409), (B, -5708), (C, -583), (D, 9815)
Parsed Result: 10398
Optimized Result: 10398
```
...
As Parsed: A * B + C
As Optimized: A * B + C
Variables: (A, 7968), (B, -6079), (C, 9772)
Parsed Result: -48427700
Optimized Result: -48427700
```
...
Variables: (A, -3663), (B, -3948), (C, 5065), (D, 809), (E, 6724), (F, -5188), (G, 6872), (H, 3554), (I, 812)
Parsed Result: 183085678
Optimized Result: 183085678
```
...
As Parsed: (A * B)
As Optimized: A * B
Variables: (A, 622), (B, 7934)
Parsed Result: 4934948
Optimized Result: 4934948
```
...
Variables: (A, 2533), (B, 3860), (C, 8637), (D, -7958), (E, -9661)
Parsed Result: 410078191
Optimized Result: 410078191
```
...
As Parsed: (((A / B) * ((C * D) * E) * F) * G) + H
As Optimized: A / B * C * D * E * F * G + H
Variables: (A, 1412), (B, -7723), (C, 5940), (D, 6993), (E, 6459), (F, 9531), (G, -2636), (H, 6409)
Parsed Result: 6409
Optimized Result: 6409
```
...
Variables: (A, -704), (B, 1942), (C, 1929), (D, -5012), (E, -5783)
Parsed Result: -1926778007
Optimized Result: -1926778007
```
...
Variables: (A, 377), (B, 6654), (C, -8899), (D, 6276)
Parsed Result: 55871576
Optimized Result: 55871576
```
...
As Parsed: ((A / B) * C) + D
As Optimized: A / B * C + D
Variables: (A, 829), (B, 781), (C, -3044), (D, 1003)
Parsed Result: -2041
Optimized Result: -2041
```
...
Variables: (A, 1131), (B, 7405), (C, -3750), (D, -6676), (E, -6264), (F, -8240), (G, 2432)
Parsed Result: 11803
Optimized Result: 11803
```
...
Variables: (A, 2273), (B, -5102), (C, -2986), (D, 9703), (E, -5637), (F, 9343), (G, 8890), (H, -4022)
Parsed Result: 126659118
Optimized Result: 126659118
```
...
As Optimized: A / B * C * D * E * F + G
Variables: (A, 270), (B, 6332), (C, -6978), (D, 679), (E, 1291), (F, -8838), (G, 8281)
Parsed Result: 8281
Optimized Result: 8281
```
...
Variables: (A, 8502), (B, 9007), (C, 984), (D, 8687), (E, -9696), (F, -5588), (G, 4638), (H, 1528)
Parsed Result: 1889949796
Optimized Result: 1889949796
```
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -2234), (B, -9808), (C, -2041), (D, -8978), (E, -8104), (F, -1109)
Parsed Result: -1109
Optimized Result: -1109
```
...
Variables: (A, 8493), (B, -4578), (C, 8902), (D, -9460), (E, -8416), (F, 5023)
Parsed Result: -1042397
Optimized Result: -1042397
```
...
Variables: (A, 5981), (B, -8232), (C, 2406), (D, 6820), (E, 7165), (F, 9912), (G, 2022), (H, 6824)
Parsed Result: -80844079
Optimized Result: -80844079
```
...
As Parsed: (A * B) + C
As Optimized: A * B + C
Variables: (A, 7688), (B, 5555), (C, -7183)
Parsed Result: 42699657
Optimized Result: 42699657
```
...
As Parsed: ((A - B) * C) + D
As Optimized: (A - B) * C + D
Variables: (A, -9198), (B, -4422), (C, -944), (D, 1944)
Parsed Result: 4510488
Optimized Result: 4510488
```
...
Variables: (A, 5209), (B, -4158), (C, 6004), (D, 7733), (E, -3513), (F, 5836), (G, 6437), (H, -3777), (I, 5275)
Parsed Result: 1755952161
Optimized Result: 1755952161
```
...
As Parsed: (((A * B) + C) * D) + E
As Optimized: ((A * B) + C) * D + E
Variables: (A, 3773), (B, -6104), (C, 2685), (D, -8758), (E, 4919)
Parsed Result: -186800087
Optimized Result: -186800087
```
...
Variables: (A, -3458), (B, -644), (C, 9672), (D, -5875), (E, -7087), (F, -736), (G, 3125), (H, 9567)
Parsed Result: 327282213
Optimized Result: 327282213
```
...
As Parsed: (A * B * C) + D
As Optimized: A * B * C + D
Variables: (A, 6661), (B, -3714), (C, -9127), (D, -5412)
Parsed Result: -1840838942
Optimized Result: -1840838942
```
...
As Optimized: (A + (-B)) / C * D * E * F * G + H
Variables: (A, 9063), (B, 4548), (C, 5374), (D, -7460), (E, -4698), (F, -8944), (G, 2048), (H, 6527)
Parsed Result: 6527
Optimized Result: 6527
```
...
As Parsed: ((A / B) * ((C * D) * E)) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 6736), (B, -3901), (C, 6165), (D, 1200), (E, -720), (F, -886)
Parsed Result: 1031591818
Optimized Result: 1031591818
```
...
As Parsed: A + B
As Optimized: A + B
Variables: (A, 7698), (B, -2062)
Parsed Result: 5636
Optimized Result: 5636
```
...
As Parsed: ((A * B) * C) + D
As Optimized: A * B * C + D
Variables: (A, -772), (B, -7915), (C, -9801), (D, 3756)
Parsed Result: 241711520
Optimized Result: 241711520
```
...
Variables: (A, 4215), (B, -3674), (C, -4918), (D, -4237), (E, 1394), (F, 3143), (G, -9639), (H, -3031), (I, -2338), (J, 4873)
Parsed Result: 1074035099
Optimized Result: 1074035099
```
...
As Parsed: ((A / (1 + (-1 * (B + C)))) * D) + E
As Optimized: A / (1 + (-(B + C))) * D + E
Variables: (A, -8060), (B, 7432), (C, 3888), (D, -7596), (E, 5626)
Parsed Result: 5626
Optimized Result: 5626
```
...
Variables: (A, -6863), (B, -4974), (C, -7343), (D, -6005), (E, 9889)
Parsed Result: 64007978
Optimized Result: 64007978
```
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -2526), (B, -9238), (C, -2016), (D, 4147), (E, -5494), (F, -4374)
Parsed Result: -4374
Optimized Result: -4374
```
...
As Optimized: (A + (-B)) / C * D * E * F + G
Variables: (A, 2064), (B, 6202), (C, 1421), (D, -22), (E, -891), (F, -2815), (G, 2056)
Parsed Result: 110361316
Optimized Result: 110361316
```
...
As Optimized: ((A / B) + (-C)) * D * E * F * G + H
Variables: (A, 7252), (B, 1082), (C, -6554), (D, 4230), (E, -6626), (F, -703), (G, 4448), (H, 9678)
Parsed Result: -1652664882
Optimized Result: -1652664882
```
...
Variables: (A, -6073), (B, -4229), (C, -3021), (D, -4759), (E, 6775), (F, -555), (G, -994), (H, -6281), (I, -4820)
Parsed Result: 469778674
Optimized Result: 469778674
```
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 3972), (B, 3260), (C, 6877), (D, -1519), (E, -3405), (F, 7312)
Parsed Result: 1209453959
Optimized Result: 1209453959
```
...
Variables: (A, 2602), (B, -9031), (C, 8653), (D, -7867), (E, 8135)
Parsed Result: -1035700359
Optimized Result: -1035700359
```
...
As Parsed: (A / B) - (C + D + E + F)
As Optimized: A / B - C + D + E + F
Variables: (A, 6410), (B, -749), (C, -5431), (D, -5398), (E, 1780), (F, -9327)
Parsed Result: 18368
Optimized Result: 18368
```
...
Variables: (A, 1005), (B, 1120), (C, -1243), (D, -8333), (E, -7236), (F, 7933), (G, -8670), (H, 6400), (I, 9338)
Parsed Result: 186344664
Optimized Result: 186344664
```
...
As Parsed: (A * B * (C / D)) + E
As Optimized: A * B * C / D + E
Variables: (A, 8640), (B, -3215), (C, -9953), (D, -2266), (E, 1799)
Parsed Result: -111108601
Optimized Result: -111108601
```
...
As Parsed: ((A / B) * (((C * D) * E) * F)) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 9648), (B, -5702), (C, -1766), (D, -4363), (E, -750), (F, -3313), (G, 6332)
Parsed Result: 1821346400
Optimized Result: 1821346400
```
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 3950), (B, -2340), (C, 3758), (D, 5162), (E, -3958), (F, 2586)
Parsed Result: 7083448
Optimized Result: 7083448
```
...
As Parsed: A * B
As Optimized: A * B
Variables: (A, 4276), (B, -8980)
Parsed Result: -38398480
Optimized Result: -38398480
```
...
As Parsed: ((A - (B * C)) * D) + E
As Optimized: (A - (B * C)) * D + E
Variables: (A, 2064), (B, -7005), (C, 9604), (D, 2203), (E, 7795)
Parsed Result: -2110228513
Optimized Result: -2110228513
```
...
Variables: (A, 4174), (B, 4254), (C, -8137), (D, 6036), (E, 785), (F, 3957), (G, -4104), (H, -7211), (I, -4149), (J, 8800), (K, 1193)
Parsed Result: -887608665
Optimized Result: -887608665
```
...
As Parsed: (((A / B) * C * D) * E * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 6018), (B, 4601), (C, -3923), (D, -44), (E, -1811), (F, -1645), (G, 4417)
Parsed Result: -1168524963
Optimized Result: -1168524963
```
...
Variables: (A, -3663), (B, 4206), (C, -7306), (D, 8636), (E, -1880), (F, 4999), (G, 3575), (H, -7620), (I, -162), (J, -4631), (K, 8877)
Parsed Result: 1211463818
Optimized Result: 1211463818
```
...
As Parsed: (((A / B) + (-1 * C)) * (D * E) * F) + G
As Optimized: ((A / B) + (-C)) * D * E * F + G
Variables: (A, -500), (B, -3146), (C, 9092), (D, 409), (E, 413), (F, -7276), (G, -3179)
Parsed Result: -1072390907
Optimized Result: -1072390907
```
...
Variables: (A, -7968), (B, -8041), (C, -1764), (D, -2134), (E, 824), (F, 3236), (G, 2688), (H, 6258)
Parsed Result: 59706006
Optimized Result: 59706006
```
...
Variables: (A, -9455), (B, 7544), (C, -7991), (D, -200), (E, 8448), (F, 623), (G, -167), (H, 4181), (I, 3844), (J, 9784)
Parsed Result: -692069404
Optimized Result: -692069404
```
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, 3933), (B, -2224), (C, -3843), (D, -4001), (E, 7892), (F, -2269)
Parsed Result: -1377495919
Optimized Result: -1377495919
```
...
Variables: (A, 8421), (B, -5501), (C, -363), (D, -6763), (E, 4788), (F, -4167)
Parsed Result: -1407051
Optimized Result: -1407051
```
