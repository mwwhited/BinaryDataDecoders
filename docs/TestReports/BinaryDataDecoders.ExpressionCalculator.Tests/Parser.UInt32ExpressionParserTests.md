...
Variables: (A, 5262), (B, 2661), (C, 4294958377), (D, 5333), (E, 4294961129), (F, 6637)
Parsed Result: 3117
Optimized Result: 3117
```
...
Variables: (A, 6648), (B, 9129), (C, 1098), (D, 4294959704)
Parsed Result: 4292235566
Optimized Result: 4292235566
```
...
Variables: (A, 4294962368), (B, 4294965579), (C, 4294961294), (D, 7410), (E, 3512), (F, 2392), (G, 4294958015), (H, 7222)
Parsed Result: 1669858615
Optimized Result: 1669858615
```
...
Variables: (A, 7107), (B, 9712), (C, 4294965528), (D, 3592), (E, 4294960803)
Parsed Result: 1864614563
Optimized Result: 1864614563
```
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, 4294966552), (B, 4294961522), (C, 2454), (D, 4294963823), (E, 6150), (F, 4294960444)
Parsed Result: 326935646
Optimized Result: 326935646
```
...
Variables: (A, 3360), (B, 3018), (C, 4294963578), (D, 1592), (E, 4294962212), (F, 1770), (G, 155), (H, 4294959089)
Parsed Result: 1186844073
Optimized Result: 1186844073
```
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 4294957484), (B, 4294967279), (C, 2873), (D, 681), (E, 789), (F, 4294963177)
Parsed Result: 4294963177
Optimized Result: 4294963177
```
...
As Parsed: (A + B) * C + D
As Optimized: (A + B) * C + D
Variables: (A, 4294964639), (B, 4294959410), (C, 7375), (D, 3940)
Parsed Result: 4217216611
Optimized Result: 4217216611
```
...
Variables: (A, 1217), (B, 837), (C, 7112), (D, 7068), (E, 9616), (F, 4294963618), (G, 6964)
Parsed Result: 2824091444
Optimized Result: 2824091444
```
...
As Parsed: ((A / B) * C) + D
As Optimized: A / B * C + D
Variables: (A, 2124), (B, 4294958447), (C, 4041), (D, 867)
Parsed Result: 867
Optimized Result: 867
```
...
Variables: (A, 6689), (B, 4294959175), (C, 4294963060), (D, 1276), (E, 4294965667), (F, 4294959041)
Parsed Result: 8391701
Optimized Result: 8391701
```
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 4294957437), (B, 4294962443), (C, 4294962446), (D, 4294966993), (E, 7929), (F, 4294966200)
Parsed Result: 4294966200
Optimized Result: 4294966200
```
...
Variables: (A, 4294961847), (B, 4294964037), (C, 8467), (D, 4294960114), (E, 7847), (F, 2440), (G, 6291), (H, 4294958834)
Parsed Result: 4294958834
Optimized Result: 4294958834
```
...
As Parsed: (A * B)
As Optimized: A * B
Variables: (A, 9090), (B, 4294963366)
Parsed Result: 4259243596
Optimized Result: 4259243596
```
...
As Parsed: ((((A / B) * C) + D) * ((E * F) * G)) + H
As Optimized: (((A / B) * C) + D) * E * F * G + H
Variables: (A, 5308), (B, 4294962640), (C, 1257), (D, 4294959515), (E, 4294963152), (F, 759), (G, 1532), (H, 7624)
Parsed Result: 2706286472
Optimized Result: 2706286472
```
...
Variables: (A, 4294964171), (B, 682), (C, 1039), (D, 7666)
Parsed Result: 7666
Optimized Result: 7666
```
...
As Parsed: (((A - (B * C)) / D) * E) + F
As Optimized: (A - (B * C)) / D * E + F
Variables: (A, 4294967260), (B, 538), (C, 5022), (D, 4294962971), (E, 4294958327), (F, 4294961379)
Parsed Result: 4294961379
Optimized Result: 4294961379
```
...
As Parsed: ((A - (B * C)) * D) + E
As Optimized: (A - (B * C)) * D + E
Variables: (A, 2831), (B, 5046), (C, 4294958322), (D, 4294966067), (E, 9582)
Parsed Result: 178539015
Optimized Result: 178539015
```
...
Variables: (A, 4294957396), (B, 8177), (C, 4294963052), (D, 4294966405), (E, 4294964131), (F, 4294964847), (G, 723), (H, 9549), (I, 4294967211)
Parsed Result: 3386569979
Optimized Result: 3386569979
```
...
As Parsed: A * B
As Optimized: A * B
Variables: (A, 4294962944), (B, 4294958079)
Parsed Result: 40112384
Optimized Result: 40112384
```
...
As Parsed: ((A * B) * C) + D
As Optimized: A * B * C + D
Variables: (A, 4880), (B, 4294960082), (C, 2047), (D, 4294965043)
Parsed Result: 951198739
Optimized Result: 951198739
```
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 2433), (B, 7077), (C, 446), (D, 4294961909), (E, 4294964618), (F, 4294961308)
Parsed Result: 4294961308
Optimized Result: 4294961308
```
...
As Parsed: (A * (B / C) + D)
As Optimized: A * B / C + D
Variables: (A, 4294959703), (B, 4294963381), (C, 3229), (D, 4294959897)
Parsed Result: 2785285736
Optimized Result: 2785285736
```
...
As Parsed: (A * B * (C / D)) + E
As Optimized: A * B * C / D + E
Variables: (A, 9736), (B, 7528), (C, 4294962868), (D, 8161), (E, 4294964075)
Parsed Result: 3480831723
Optimized Result: 3480831723
```
...
As Parsed: ((A / B) * ((C * D) * E) * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 4294963808), (B, 8874), (C, 4294959154), (D, 6378), (E, 4294964150), (F, 4294960128), (G, 4294959964)
Parsed Result: 1800840028
Optimized Result: 1800840028
```
...
As Parsed: (((A * B) + C) * D) + E
As Optimized: ((A * B) + C) * D + E
Variables: (A, 4294962033), (B, 4294959053), (C, 4294958386), (D, 2102), (E, 3800)
Parsed Result: 977836482
Optimized Result: 977836482
```
...
As Parsed: A + B
As Optimized: A + B
Variables: (A, 8606), (B, 4294965533)
Parsed Result: 6843
Optimized Result: 6843
```
...
Variables: (A, 4294965148), (B, 4294963293), (C, 4294962795), (D, 4953), (E, 4294963310), (F, 4294965814), (G, 4294963675), (H, 4294961232), (I, 3624), (J, 6364)
Parsed Result: 2989152051
Optimized Result: 2989152051
```
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 4294962640), (B, 4294957899), (C, 4294960735), (D, 4294957601), (E, 5179), (F, 4294960904)
Parsed Result: 3012946317
Optimized Result: 3012946317
```
...
Variables: (A, 4294959678), (B, 8474), (C, 8205), (D, 4294964228), (E, 4294957396)
Parsed Result: 4204412437
Optimized Result: 4204412437
```
...
As Parsed: (A * B * C) + D
As Optimized: A * B * C + D
Variables: (A, 1182), (B, 4294957393), (C, 4294958958), (D, 4294962312)
Parsed Result: 3109889452
Optimized Result: 3109889452
```
...
As Parsed: A * 1
As Optimized: A
Variables: (A, 4294964760)
Parsed Result: 4294964760
Optimized Result: 4294964760
```
...
Variables: (A, 5821), (B, 1380), (C, 4294961714), (D, 4294958438), (E, 4294967165), (F, 4294967086), (G, 4294959643), (H, 2548)
Parsed Result: 4150464938
Optimized Result: 4150464938
```
...
Variables: (A, 5821), (B, 4913), (C, 4294960019), (D, 4294966168), (E, 4294958503), (F, 4294965817), (G, 372), (H, 6728)
Parsed Result: 1355796512
Optimized Result: 1355796512
```
...
Variables: (A, 734), (B, 1119), (C, 3236), (D, 4294965427), (E, 7072)
Parsed Result: 4152841200
Optimized Result: 4152841200
```
...
As Parsed: (((A / B) * C * D) * E * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 8246), (B, 1735), (C, 4294960223), (D, 4294961849), (E, 7120), (F, 4294961095), (G, 4879)
Parsed Result: 4182238799
Optimized Result: 4182238799
```
...
Variables: (A, 4294963605), (B, 8762), (C, 4294959377), (D, 4294958422), (E, 4294962437), (F, 6936)
Parsed Result: 4256991429
Optimized Result: 4256991429
```
...
As Parsed: ((A / B) * ((C * D) * E)) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 4294959324), (B, 2813), (C, 1270), (D, 4294958401), (E, 4294966024), (F, 4294963369)
Parsed Result: 3966192089
Optimized Result: 3966192089
```
...
As Parsed: (A * B) + C
As Optimized: A * B + C
Variables: (A, 4294965953), (B, 4294964471), (C, 4294966576)
Parsed Result: 3793255
Optimized Result: 3793255
```
...
As Parsed: A * (B / C) + D
As Optimized: A * B / C + D
Variables: (A, 4294959252), (B, 4294958763), (C, 2042), (D, 4294961890)
Parsed Result: 260846182
Optimized Result: 260846182
```
...
As Parsed: A * B + C
As Optimized: A * B + C
Variables: (A, 4294966181), (B, 924), (C, 4294965742)
Parsed Result: 4293935482
Optimized Result: 4293935482
```
