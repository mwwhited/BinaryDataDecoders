...
Variables: (A, 4294961599), (B, 4294964095), (C, 4294958212), (D, 4294960742), (E, 9648), (F, 2968), (G, 4294960427)
Parsed Result: 4294960427
Optimized Result: 4294960427
```
...
Variables: (A, 4925), (B, 584), (C, 4294964667), (D, 4294960250), (E, 1519), (F, 4294957875), (G, 3937), (H, 4294965033)
Parsed Result: 1400026201
Optimized Result: 1400026201
```
...
Variables: (A, 4294959188), (B, 5590), (C, 4209), (D, 4294962976), (E, 4294960460), (F, 4294959349)
Parsed Result: 3398857333
Optimized Result: 3398857333
```
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 213), (B, 3148), (C, 8362), (D, 3346), (E, 4294962376), (F, 8464)
Parsed Result: 4293981920
Optimized Result: 4293981920
```
...
Variables: (A, 4294959063), (B, 6226), (C, 6314), (D, 4294959335), (E, 145), (F, 4294964613)
Parsed Result: 4281993439
Optimized Result: 4281993439
```
...
Variables: (A, 4294964480), (B, 9602), (C, 2844), (D, 6681)
Parsed Result: 1272122193
Optimized Result: 1272122193
```
...
Variables: (A, 4294966739), (B, 4630), (C, 8750), (D, 4294959445), (E, 9670)
Parsed Result: 3897130635
Optimized Result: 3897130635
```
...
Variables: (A, 5046), (B, 8711), (C, 4294959641), (D, 2131), (E, 240), (F, 21), (G, 1765), (H, 4294963592)
Parsed Result: 3754516149
Optimized Result: 3754516149
```
...
As Parsed: A * (B / C) + D
As Optimized: A * B / C + D
Variables: (A, 4294960510), (B, 4294960523), (C, 4294958749), (D, 4294965199)
Parsed Result: 4294958413
Optimized Result: 4294958413
```
...
As Parsed: ((A * B) * C) + D
As Optimized: A * B * C + D
Variables: (A, 4294964586), (B, 4294964219), (C, 1436), (D, 67)
Parsed Result: 3384395595
Optimized Result: 3384395595
```
...
As Parsed: (A - B) / A
As Optimized: (A - B) / A
Variables: (A, 4294958565), (B, 4294964928)
Parsed Result: 1
Optimized Result: 1
```
...
As Parsed: A * B + C
As Optimized: A * B + C
Variables: (A, 4294960517), (B, 5269), (C, 9700)
Parsed Result: 4259258445
Optimized Result: 4259258445
```
...
Variables: (A, 6659), (B, 4294964729), (C, 4294964583), (D, 4294967241), (E, 3004)
Parsed Result: 3004
Optimized Result: 3004
```
...
As Parsed: (A * B) + C
As Optimized: A * B + C
Variables: (A, 4294964233), (B, 668), (C, 3387)
Parsed Result: 4292924599
Optimized Result: 4292924599
```
...
As Parsed: (((A * B) + C) * D) + E
As Optimized: ((A * B) + C) * D + E
Variables: (A, 7725), (B, 4294965497), (C, 4294963712), (D, 4294960691), (E, 1910)
Parsed Result: 1620862389
Optimized Result: 1620862389
```
...
As Parsed: ((A - (B * C)) * D) + E
As Optimized: (A - (B * C)) * D + E
Variables: (A, 4294958139), (B, 4294966356), (C, 2994), (D, 9757), (E, 4294965486)
Parsed Result: 1600560085
Optimized Result: 1600560085
```
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 4294957849), (B, 746), (C, 1600), (D, 2847), (E, 4294964748), (F, 3852)
Parsed Result: 442098444
Optimized Result: 442098444
```
...
Variables: (A, 8719), (B, 3907), (C, 4294957572), (D, 3951), (E, 1596), (F, 4294964257), (G, 4294959360), (H, 6169), (I, 4294960025)
Parsed Result: 3810018322
Optimized Result: 3810018322
```
...
Variables: (A, 3410), (B, 4294965809), (C, 4294958706), (D, 4294965788), (E, 3821), (F, 5396), (G, 4294960661), (H, 8100)
Parsed Result: 4246389116
Optimized Result: 4246389116
```
...
As Parsed: A * B
As Optimized: A * B
Variables: (A, 8929), (B, 2470)
Parsed Result: 22054630
Optimized Result: 22054630
```
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 4402), (B, 2606), (C, 4294964285), (D, 4294957932), (E, 4294959139), (F, 4294958033)
Parsed Result: 1941577093
Optimized Result: 1941577093
```
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, 4294961760), (B, 4294965337), (C, 4294966601), (D, 4294960414), (E, 4294960987), (F, 4294963352)
Parsed Result: 566822297
Optimized Result: 566822297
```
...
As Parsed: ((((A / B) * C) + D) * ((E * F) * G)) + H
As Optimized: (((A / B) * C) + D) * E * F * G + H
Variables: (A, 9537), (B, 551), (C, 5495), (D, 4294965859), (E, 4294966858), (F, 1527), (G, 4294960567), (H, 9640)
Parsed Result: 814525772
Optimized Result: 814525772
```
...
As Parsed: (((A / B) * C * D) * E * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 7138), (B, 4294963172), (C, 4294958732), (D, 6237), (E, 2300), (F, 4294964275), (G, 4294966563)
Parsed Result: 4294966563
Optimized Result: 4294966563
```
...
Variables: (A, 1272), (B, 1208), (C, 6868), (D, 7657), (E, 3645), (F, 8934), (G, 4294967184), (H, 4294963973)
Parsed Result: 2967894163
Optimized Result: 2967894163
```
...
As Parsed: (((A - (B * C)) / D) * E) + F
As Optimized: (A - (B * C)) / D * E + F
Variables: (A, 4004), (B, 4294964520), (C, 4294964546), (D, 7568), (E, 3571), (F, 8976)
Parsed Result: 2023009044
Optimized Result: 2023009044
```
...
Variables: (A, 3326), (B, 8445), (C, 4294958710), (D, 9699)
Parsed Result: 9699
Optimized Result: 9699
```
...
Variables: (A, 4294962130), (B, 4294965496), (C, 4294961445), (D, 9364), (E, 3226), (F, 4294957399), (G, 4294965873), (H, 4294959853), (I, 4294967022), (J, 4728)
Parsed Result: 1115536097
Optimized Result: 1115536097
```
...
As Parsed: A + B
As Optimized: A + B
Variables: (A, 4294958210), (B, 4294961509)
Parsed Result: 4294952423
Optimized Result: 4294952423
```
...
As Parsed: (A / B) - (C + D + E + F)
As Optimized: A / B - C + D + E + F
Variables: (A, 3045), (B, 4294960845), (C, 9745), (D, 849), (E, 2712), (F, 5201)
Parsed Result: 4294948789
Optimized Result: 4294948789
```
...
Variables: (A, 4294963234), (B, 4294958880), (C, 4294960798), (D, 4294966626), (E, 9835)
Parsed Result: 39827849
Optimized Result: 39827849
```
...
Variables: (A, 4294959677), (B, 4294960609), (C, 4294957323), (D, 4294966884), (E, 8207), (F, 4294962869), (G, 1527), (H, 1387)
Parsed Result: 1778335537
Optimized Result: 1778335537
```
...
Variables: (A, 7406), (B, 4294958756), (C, 6304), (D, 4294961356), (E, 2458), (F, 4294965883)
Parsed Result: 22275441
Optimized Result: 22275441
```
...
As Parsed: (A * (B / C) + D)
As Optimized: A * B / C + D
Variables: (A, 209), (B, 4516), (C, 4294961198), (D, 8054)
Parsed Result: 8054
Optimized Result: 8054
```
...
As Parsed: (A + B) * C + D
As Optimized: (A + B) * C + D
Variables: (A, 4294960494), (B, 4294959827), (C, 4294965361), (D, 4294958178)
Parsed Result: 27605267
Optimized Result: 27605267
```
...
As Parsed: (A * B)
As Optimized: A * B
Variables: (A, 4294960146), (B, 9213)
Parsed Result: 4229094346
Optimized Result: 4229094346
```
...
As Parsed: ((A - B) * C) + D
As Optimized: (A - B) * C + D
Variables: (A, 110), (B, 4294961981), (C, 4294967230), (D, 8296)
Parsed Result: 4294617542
Optimized Result: 4294617542
```
...
As Parsed: (A * B * C) + D
As Optimized: A * B * C + D
Variables: (A, 3533), (B, 4294963389), (C, 4294957661), (D, 4294957428)
Parsed Result: 4147028937
Optimized Result: 4147028937
```
...
As Parsed: ((A / B) * ((C * D) * E) * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 3395), (B, 4294966672), (C, 1044), (D, 4294960469), (E, 9370), (F, 4294967106), (G, 169)
Parsed Result: 169
Optimized Result: 169
```
...
As Parsed: (((A * B) * C) * D) + E
As Optimized: A * B * C * D + E
Variables: (A, 9020), (B, 4294967284), (C, 9787), (D, 4294962680), (E, 4294958865)
Parsed Result: 2263174801
Optimized Result: 2263174801
```
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 4294957302), (B, 4294965254), (C, 4294966711), (D, 2052), (E, 5741), (F, 3473)
Parsed Result: 3473
Optimized Result: 3473
```
