...
| :------------------- | ----------: | :--------------------------------------------------- |
| ⚠ Inconclusive       | 00:00:00.14 | `VerifyOptimizerForComplexExpressions`               |
| ✔ Passed             | 00:00:00.05 | `Check Expressions "A"`                              |
...
| ⚠ Inconclusive       | 00:00:00.01 | `OptimizerTests (B%-1,0)`                            |
...
| ✔ Passed             | 00:00:00.01 | `PoorlyFormedExpressions (B**A)`                     |
