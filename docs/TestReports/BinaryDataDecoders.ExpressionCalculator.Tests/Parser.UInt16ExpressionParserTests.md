...
| :----------------------- | ----------: | :--------------------------------------------------- |
|  ⚠ Inconclusive        | 00:00:00.17 | `VerifyOptimizerForComplexExpressions              ` |
...
|  ✔ Passed               | 00:00:00.01 | `Check Expressions "((A+B+((C*D)+E))*F)+G+((D/H)*I)` |
...
|  ⚠ Inconclusive        | 00:00:00.02 | `Check Expressions "((A*(B+(-1*C)))+D)+((E*(B+(-1*C` |
...
| Result                   | Duration    | Test Name                                            |
| :----------------------- | ----------: | :--------------------------------------------------- |
|  ✔ Passed               | 00:00:00.02 | `PoorlyFormedExpressions                           ` |
