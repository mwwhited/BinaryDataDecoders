...
| ⚠ Inconclusive       | 00:00:00.02 | `Check Expressions "(A*(((B*C)+D)+((E*F)+G)))+(-1*(B+(-1*((B*C)+D))))+(H*(((B*I)+J)+((E*F)+G)+(A*(((B*C)+D)+((E*F)+G)))+(-1*(B+(-1*((B*C)+D)))))+K)"` |
...
| ✔ Passed             | 00:00:00.01 | `Check Expressions "(((A/B)*(((C*D)*E)*F))+(C*D*G))+H"` |
...
| Outcome              | Duration    | Test Name                                            |
| :------------------- | ----------: | :--------------------------------------------------- |
| ⚠ Inconclusive       | 00:00:00.07 | `OptimizerTests`                                     |
| ✔ Passed             | 00:00:00.02 | `OptimizerTests ((A),A)`                             |
