...
Variables: (A, 179), (B, 248), (C, 212), (D, 137), (E, 173), (F, 11), (G, 110), (H, 147), (I, 78), (J, 84)
Parsed Result: 134
Optimized Result: 134
```
...
Variables: (A, 115), (B, 118), (C, 35), (D, 18), (E, 11), (F, 97), (G, 180), (H, 214)
Parsed Result: 0
Optimized Result: 0
```
...
Variables: (A, 207), (B, 199), (C, 32), (D, 88), (E, 83)
Parsed Result: 123
...
Variables: (A, 174), (B, 52), (C, 116), (D, 233), (E, 48), (F, 103)
Parsed Result: 103
...
Variables: (A, 198), (B, 54), (C, 16), (D, 144), (E, 94), (F, 197)
Parsed Result: 157
...
Variables: (A, 114), (B, 131), (C, 46), (D, 117), (E, 150), (F, 77)
Parsed Result: 227
Optimized Result: 227
```
...
Variables: (A, 44), (B, 49), (C, 112), (D, 144)
Parsed Result: 144
Optimized Result: 144
```
...
Variables: (A, 74), (B, 212), (C, 78), (D, 178), (E, 63), (F, 10), (G, 182), (H, 33)
Parsed Result: 201
...
As Parsed: A * B
As Optimized: A * B
Variables: (A, 40), (B, 210)
Parsed Result: 208
Optimized Result: 208
```
...
As Parsed: (((A * B) * C) * D) + E
As Optimized: A * B * C * D + E
Variables: (A, 101), (B, 48), (C, 36), (D, 9), (E, 116)
Parsed Result: 52
Optimized Result: 52
```
...
Variables: (A, 93), (B, 68), (C, 204), (D, 245), (E, 134), (F, 165), (G, 160), (H, 162), (I, 128)
Parsed Result: 211
...
Variables: (A, 10), (B, 78), (C, 156), (D, 107), (E, 171), (F, 105), (G, 224)
Parsed Result: 224
...
As Parsed: ((A * B) * C) + D
As Optimized: A * B * C + D
Variables: (A, 89), (B, 255), (C, 64), (D, 168)
Parsed Result: 104
...
As Parsed: ((A / B) * (((C * D) * E) * F)) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 158), (B, 128), (C, 28), (D, 212), (E, 33), (F, 85), (G, 223)
Parsed Result: 207
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 249), (B, 75), (C, 207), (D, 56), (E, 147), (F, 12)
Parsed Result: 20
Optimized Result: 20
```
...
As Parsed: (A * B * (C / D)) + E
As Optimized: A * B * C / D + E
Variables: (A, 32), (B, 37), (C, 240), (D, 108), (E, 177)
Parsed Result: 241
...
Variables: (A, 15), (B, 28), (C, 2), (D, 85), (E, 108), (F, 81), (G, 144), (H, 32)
Parsed Result: 224
Optimized Result: 224
```
...
Variables: (A, 170), (B, 159), (C, 159), (D, 61), (E, 44)
Parsed Result: 68
Optimized Result: 68
```
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, 6), (B, 252), (C, 102), (D, 92), (E, 110), (F, 18)
Parsed Result: 222
Optimized Result: 222
```
...
As Parsed: (A + B) * C + D
As Optimized: (A + B) * C + D
Variables: (A, 149), (B, 95), (C, 34), (D, 141)
Parsed Result: 245
Optimized Result: 245
```
...
As Parsed: ((A / B) * ((C * D) * E) * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 229), (B, 249), (C, 200), (D, 10), (E, 166), (F, 186), (G, 57)
Parsed Result: 57
Optimized Result: 57
```
...
Variables: (A, 209), (B, 92), (C, 145), (D, 209), (E, 212), (F, 174), (G, 136), (H, 78)
Parsed Result: 68
Optimized Result: 68
```
...
As Parsed: ((A / B) * ((C * D) * E)) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 212), (B, 18), (C, 26), (D, 172), (E, 118), (F, 130)
Parsed Result: 242
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 185), (B, 19), (C, 191), (D, 85), (E, 237), (F, 29)
Parsed Result: 10
Optimized Result: 10
```
...
As Parsed: ((A / B) * C) + D
As Optimized: A / B * C + D
Variables: (A, 67), (B, 242), (C, 170), (D, 100)
Parsed Result: 100
...
As Parsed: (((A / B) * ((C * D) * E) * F) * G) + H
As Optimized: A / B * C * D * E * F * G + H
Variables: (A, 104), (B, 36), (C, 255), (D, 9), (E, 167), (F, 135), (G, 229), (H, 212)
Parsed Result: 26
Optimized Result: 26
```
...
As Parsed: (A / B) - (C + D + E + F)
As Optimized: A / B - C + D + E + F
Variables: (A, 216), (B, 87), (C, 107), (D, 172), (E, 106), (F, 71)
Parsed Result: 58
Optimized Result: 58
```
...
As Parsed: (A * B)
As Optimized: A * B
Variables: (A, 122), (B, 12)
Parsed Result: 184
Optimized Result: 184
```
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 40), (B, 241), (C, 22), (D, 154), (E, 162), (F, 61)
Parsed Result: 61
Optimized Result: 61
```
...
As Parsed: ((A - B) * C) + D
As Optimized: (A - B) * C + D
Variables: (A, 56), (B, 172), (C, 141), (D, 188)
Parsed Result: 216
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 80), (B, 60), (C, 3), (D, 169), (E, 166), (F, 153)
Parsed Result: 91
Optimized Result: 91
```
...
As Parsed: (A * B * C) + D
As Optimized: A * B * C + D
Variables: (A, 66), (B, 216), (C, 173), (D, 111)
Parsed Result: 95
Optimized Result: 95
```
...
Variables: (A, 253), (B, 183), (C, 42), (D, 130)
Parsed Result: 0
Optimized Result: 0
```
...
Variables: (A, 119), (B, 113), (C, 165), (D, 192), (E, 188)
Parsed Result: 67
Optimized Result: 67
```
...
As Parsed: (((A * B) + C) * D) + E
As Optimized: ((A * B) + C) * D + E
Variables: (A, 128), (B, 189), (C, 76), (D, 56), (E, 202)
Parsed Result: 106
...
Variables: (A, 234), (B, 34), (C, 32), (D, 184), (E, 174), (F, 255), (G, 166), (H, 202)
Parsed Result: 227
Optimized Result: 227
```
