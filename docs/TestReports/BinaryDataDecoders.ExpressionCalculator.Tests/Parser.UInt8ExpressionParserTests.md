...
As Parsed: (A * B)
As Optimized: A * B
Variables: (A, 251), (B, 13)
Parsed Result: 191
Optimized Result: 191
```
...
Variables: (A, 57), (B, 193), (C, 102), (D, 35), (E, 42), (F, 105), (G, 180), (H, 162)
Parsed Result: 151
...
Variables: (A, 45), (B, 171), (C, 108), (D, 1), (E, 98), (F, 173)
Parsed Result: 132
...
Variables: (A, 251), (B, 148), (C, 82), (D, 198)
Parsed Result: 190
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 118), (B, 34), (C, 212), (D, 193), (E, 226), (F, 191)
Parsed Result: 55
Optimized Result: 55
```
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 47), (B, 39), (C, 235), (D, 52), (E, 190), (F, 223)
Parsed Result: 223
...
Variables: (A, 227), (B, 197), (C, 171), (D, 150), (E, 180), (F, 254), (G, 13), (H, 123)
Parsed Result: 107
...
Variables: (A, 226), (B, 29), (C, 162), (D, 123), (E, 94)
Parsed Result: 26
Optimized Result: 26
```
...
As Parsed: (A * B) + C
As Optimized: A * B + C
Variables: (A, 238), (B, 226), (C, 185)
Parsed Result: 213
Optimized Result: 213
```
...
Variables: (A, 163), (B, 159), (C, 73), (D, 110), (E, 175)
Parsed Result: 135
Optimized Result: 135
```
...
Variables: (A, 24), (B, 34), (C, 196), (D, 44), (E, 107), (F, 243), (G, 128), (H, 254), (I, 132), (J, 79)
Parsed Result: 126
...
Variables: (A, 127), (B, 249), (C, 231), (D, 181), (E, 134), (F, 203)
Parsed Result: 152
Optimized Result: 152
```
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, 165), (B, 95), (C, 33), (D, 15), (E, 15), (F, 139)
Parsed Result: 135
Optimized Result: 135
```
...
Variables: (A, 190), (B, 242), (C, 211), (D, 118)
Parsed Result: 90
Optimized Result: 90
```
...
As Parsed: (A + B) * C + D
As Optimized: (A + B) * C + D
Variables: (A, 163), (B, 233), (C, 135), (D, 40)
Parsed Result: 252
Optimized Result: 252
```
...
Variables: (A, 235), (B, 199), (C, 170), (D, 176), (E, 28), (F, 173), (G, 182), (H, 192)
Parsed Result: 196
Optimized Result: 196
```
...
Variables: (A, 242), (B, 151), (C, 153), (D, 22), (E, 64)
Parsed Result: 30
Optimized Result: 30
```
...
As Parsed: ((((A / B) * C) + D) * ((E * F) * G)) + H
As Optimized: (((A / B) * C) + D) * E * F * G + H
Variables: (A, 132), (B, 46), (C, 237), (D, 64), (E, 69), (F, 237), (G, 234), (H, 222)
Parsed Result: 34
Optimized Result: 34
```
...
Variables: (A, 156), (B, 188), (C, 72), (D, 35), (E, 186), (F, 202), (G, 229), (H, 75), (I, 187)
Parsed Result: 11
Optimized Result: 11
```
...
As Parsed: (((A - (B * C)) / D) * E) + F
As Optimized: (A - (B * C)) / D * E + F
Variables: (A, 62), (B, 244), (C, 247), (D, 120), (E, 14), (F, 73)
Parsed Result: 87
Optimized Result: 87
```
...
As Parsed: (A * (B / C) + D)
As Optimized: A * B / C + D
Variables: (A, 173), (B, 234), (C, 205), (D, 228)
Parsed Result: 145
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 202), (B, 96), (C, 213), (D, 3), (E, 189), (F, 42)
Parsed Result: 176
...
As Parsed: A * (B / C) + D
As Optimized: A * B / C + D
Variables: (A, 234), (B, 194), (C, 49), (D, 59)
Parsed Result: 249
Optimized Result: 249
```
...
As Parsed: ((A - B) * C) + D
As Optimized: (A - B) * C + D
Variables: (A, 156), (B, 211), (C, 253), (D, 165)
Parsed Result: 74
Optimized Result: 74
```
...
Variables: (A, 255), (B, 175), (C, 147), (D, 169), (E, 80), (F, 212), (G, 162)
Parsed Result: 98
Optimized Result: 98
```
...
As Parsed: (((A / B) * C * D) * E * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 235), (B, 104), (C, 203), (D, 32), (E, 135), (F, 217), (G, 198)
Parsed Result: 6
Optimized Result: 6
```
...
As Parsed: ((A * B) * C) + D
As Optimized: A * B * C + D
Variables: (A, 88), (B, 28), (C, 41), (D, 178)
Parsed Result: 82
Optimized Result: 82
```
...
As Parsed: ((A / B) * C) + D
As Optimized: A / B * C + D
Variables: (A, 51), (B, 90), (C, 114), (D, 42)
Parsed Result: 42
Optimized Result: 42
```
...
As Parsed: (A * B * (C / D)) + E
As Optimized: A * B * C / D + E
Variables: (A, 230), (B, 232), (C, 59), (D, 174), (E, 121)
Parsed Result: 121
...
As Parsed: (((A * B) + C) * D) + E
As Optimized: ((A * B) + C) * D + E
Variables: (A, 168), (B, 122), (C, 149), (D, 240), (E, 5)
Parsed Result: 181
...
As Parsed: ((A / B) * ((C * D) * E) * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, 15), (B, 79), (C, 66), (D, 71), (E, 23), (F, 206), (G, 94)
Parsed Result: 94
Optimized Result: 94
```
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 169), (B, 99), (C, 66), (D, 98), (E, 13), (F, 85)
Parsed Result: 201
...
Variables: (A, 203), (B, 117), (C, 242), (D, 83), (E, 14), (F, 110), (G, 76), (H, 42)
Parsed Result: 72
Optimized Result: 72
```
...
Variables: (A, 226), (B, 2), (C, 29), (D, 50), (E, 231), (F, 211)
Parsed Result: 211
Optimized Result: 211
```
...
Variables: (A, 66), (B, 109), (C, 187), (D, 195), (E, 45), (F, 226), (G, 205), (H, 182)
Parsed Result: 51
Optimized Result: 51
```
...
As Parsed: ((A / B) * ((C * D) * E)) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 179), (B, 103), (C, 97), (D, 211), (E, 213), (F, 226)
Parsed Result: 17
Optimized Result: 17
```
...
As Parsed: ((A - (B * C)) * D) + E
As Optimized: (A - (B * C)) * D + E
Variables: (A, 80), (B, 108), (C, 215), (D, 88), (E, 187)
Parsed Result: 91
Optimized Result: 91
```
