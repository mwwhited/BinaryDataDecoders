...
Variables: (A, -6405), (B, 77), (C, -3527), (D, -1076), (E, -1225)
Parsed Result: 14807
Optimized Result: 14807
```
...
Variables: (A, -1257), (B, -5888), (C, -4233), (D, 1464), (E, 2907), (F, 2278), (G, 1495), (H, -4726), (I, 4684), (J, -8726), (K, 9980), (L, -5178)
Parsed Result: -18835
Optimized Result: -18835
```
...
As Parsed: (A * B * (C / D)) + E
As Optimized: A * B * C / D + E
Variables: (A, 2509), (B, -3821), (C, -4216), (D, -1910), (E, 7868)
Parsed Result: -29398
Optimized Result: -29398
```
...
Variables: (A, 4894), (B, 2965), (C, 5106), (D, -3367)
Parsed Result: -3367
Optimized Result: -3367
```
...
Variables: (A, 6628), (B, 1597), (C, 962), (D, -5474), (E, 8976), (F, 425), (G, 7754), (H, 4942), (I, 7571), (J, 2850), (K, -7396)
Parsed Result: -21625
Optimized Result: -21625
```
...
Variables: (A, 3330), (B, 6857), (C, 6490), (D, 6896), (E, -6082), (F, 9473), (G, 8682)
Parsed Result: -25942
Optimized Result: -25942
```
...
Variables: (A, -4614), (B, 4775), (C, 6027), (D, -383), (E, 9152), (F, -9299)
Parsed Result: -9299
Optimized Result: -9299
```
...
Variables: (A, -8631), (B, -7874), (C, 3920)
Parsed Result: 12213
Optimized Result: 12213
```
...
Variables: (A, 8143), (B, -4253), (C, -7921), (D, 7210), (E, 8226), (F, 4613), (G, -8048), (H, -5455), (I, -7438)
Parsed Result: -1725
Optimized Result: -1725
```
...
As Optimized: A / B * C * D * E * F + G
Variables: (A, -5687), (B, -4531), (C, -5356), (D, -7330), (E, -700), (F, 6159), (G, -773)
Parsed Result: -20581
Optimized Result: -20581
```
...
Variables: (A, -7137), (B, -8677), (C, 8666), (D, -2137), (E, 7753), (F, 7828), (G, -3087)
Parsed Result: -10915
Optimized Result: -10915
```
...
As Parsed: A + B
As Optimized: A + B
Variables: (A, -4084), (B, -5386)
Parsed Result: -9470
Optimized Result: -9470
```
...
Variables: (A, -856), (B, -2015), (C, 4416), (D, 8035), (E, -8177), (F, 9480), (G, 837), (H, 7867)
Parsed Result: 27003
Optimized Result: 27003
```
...
Variables: (A, -5407), (B, 7585), (C, 2859), (D, -4978)
Parsed Result: 22798
Optimized Result: 22798
```
...
As Parsed: ((A / B) * (C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -2242), (B, 4521), (C, -3043), (D, -6310), (E, 7297), (F, -824)
Parsed Result: -824
Optimized Result: -824
```
...
As Parsed: (A * B) + C
As Optimized: A * B + C
Variables: (A, -3619), (B, 4488), (C, 3370)
Parsed Result: 14226
Optimized Result: 14226
```
...
Variables: (A, -55), (B, 6126), (C, -4863), (D, 9773), (E, 8931), (F, -1336), (G, -5106), (H, 3939), (I, 608), (J, -5265), (K, 5331)
Parsed Result: -32758
Optimized Result: -32758
```
...
As Parsed: ((A - B) * C) + D
As Optimized: (A - B) * C + D
Variables: (A, 2479), (B, -8862), (C, -9428), (D, -7405)
Parsed Result: 24399
Optimized Result: 24399
```
...
Variables: (A, -2825), (B, -7628), (C, 5708), (D, -792), (E, -848), (F, 5887), (G, 2321), (H, 5589), (I, 2471), (J, 1100)
Parsed Result: 418
Optimized Result: 418
```
...
Variables: (A, -5279), (B, -7912), (C, 2375), (D, -5414), (E, 175), (F, 692), (G, 5031), (H, 6887)
Parsed Result: -32743
Optimized Result: -32743
```
...
As Parsed: (((A * B) * C) * D) + E
As Optimized: A * B * C * D + E
Variables: (A, 4022), (B, -5373), (C, 4160), (D, -9284), (E, 5231)
Parsed Result: 21103
Optimized Result: 21103
```
...
Variables: (A, 5324), (B, 377), (C, -7466), (D, -9534), (E, -1675), (F, 5236)
Parsed Result: -24423
Optimized Result: -24423
```
...
Variables: (A, 1999), (B, -2987), (C, -3554), (D, 9653), (E, 8148), (F, -8325), (G, -3875), (H, 6813)
Parsed Result: 6869
Optimized Result: 6869
```
...
As Optimized: (A + (-B)) / C * D * E * F + G
Variables: (A, 8004), (B, 9529), (C, -8773), (D, -2178), (E, -21), (F, 7287), (G, -5628)
Parsed Result: -5628
Optimized Result: -5628
```
...
As Parsed: (((A / B) + (-1 * C)) * D * E * F) + G
As Optimized: ((A / B) + (-C)) * D * E * F + G
Variables: (A, 7836), (B, 1082), (C, -2689), (D, -1462), (E, -6300), (F, 3339), (G, -7606)
Parsed Result: -29174
Optimized Result: -29174
```
...
Variables: (A, -4360), (B, 4081), (C, -2693), (D, -2968), (E, -1883)
Parsed Result: 15005
Optimized Result: 15005
```
...
Variables: (A, 7965), (B, 9932), (C, -8276), (D, -6226), (E, 9150), (F, -3550), (G, -3515), (H, -7396)
Parsed Result: 2767
Optimized Result: 2767
```
...
As Parsed: A * B + C
As Optimized: A * B + C
Variables: (A, 4407), (B, 1851), (C, 489)
Parsed Result: 31382
Optimized Result: 31382
```
...
Variables: (A, 5669), (B, 226), (C, 7025), (D, 8379), (E, -5493), (F, -9900), (G, 8338), (H, 7362), (I, -7986), (J, 4245), (K, 5311), (L, -6367)
Parsed Result: -6921
Optimized Result: -6921
```
...
Variables: (A, 2002), (B, -11), (C, -6504), (D, 641), (E, 7269), (F, 2682), (G, 9339), (H, 4870), (I, -2892), (J, -9045)
Parsed Result: -22207
Optimized Result: -22207
```
...
As Parsed: ((A / B) * C) + D
As Optimized: A / B * C + D
Variables: (A, -3532), (B, -7069), (C, -7834), (D, 2392)
Parsed Result: 2392
Optimized Result: 2392
```
...
As Parsed: ((A * B) + C) + (D * E * F)
As Optimized: A * B + C + D * E * F
Variables: (A, -8269), (B, 3557), (C, 5886), (D, -3943), (E, 4674), (F, 5403)
Parsed Result: -7645
Optimized Result: -7645
```
...
As Optimized: A / B * C * D * E * F * G + H
Variables: (A, -317), (B, 130), (C, -1692), (D, -2111), (E, 9377), (F, -5898), (G, 9133), (H, -6160)
Parsed Result: 12672
Optimized Result: 12672
```
...
As Parsed: (A + B) * C + D
As Optimized: (A + B) * C + D
Variables: (A, 7102), (B, -5463), (C, -3794), (D, -6536)
Parsed Result: 1018
Optimized Result: 1018
```
...
Variables: (A, 5603), (B, 3721), (C, 634), (D, 9479), (E, -8892), (F, -6900), (G, 9485), (H, -764), (I, 3508)
Parsed Result: 5453
Optimized Result: 5453
```
...
As Parsed: (A * B)
As Optimized: A * B
Variables: (A, 197), (B, 9659)
Parsed Result: 2279
Optimized Result: 2279
```
...
As Parsed: (((A / B) * C * D) * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, 3432), (B, 2387), (C, 1479), (D, -2318), (E, 1551), (F, 8599)
Parsed Result: 10073
Optimized Result: 10073
```
...
Variables: (A, -1870), (B, 8290), (C, -3469), (D, -5389)
Parsed Result: -5389
Optimized Result: -5389
```
...
As Parsed: A * (B / C) + D
As Optimized: A * B / C + D
Variables: (A, -6112), (B, -786), (C, -7157), (D, 6875)
Parsed Result: 6875
Optimized Result: 6875
```
...
Variables: (A, 5113), (B, -5098), (C, -2167), (D, -4897), (E, 2836), (F, 7370)
Parsed Result: -9646
Optimized Result: -9646
```
...
As Parsed: ((A - (B * C)) * D) + E
As Optimized: (A - (B * C)) * D + E
Variables: (A, 2864), (B, -3103), (C, 3463), (D, 9650), (E, -7057)
Parsed Result: 29873
Optimized Result: 29873
```
...
As Parsed: ((A * B) * C) + D
As Optimized: A * B * C + D
Variables: (A, -8454), (B, -5636), (C, 6087), (D, 6840)
Parsed Result: -29344
Optimized Result: -29344
```
...
As Parsed: A * B
As Optimized: A * B
Variables: (A, 269), (B, -364)
Parsed Result: -32380
Optimized Result: -32380
```
...
As Parsed: ((A / B) * (((C * D) * E) * F)) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, -7621), (B, 5025), (C, 5843), (D, -2189), (E, 7891), (F, 6424), (G, -6606)
Parsed Result: -3286
Optimized Result: -3286
```
...
Variables: (A, 8682), (B, 1636), (C, 6928), (D, 1640), (E, 2224)
Parsed Result: -12344
Optimized Result: -12344
```
...
As Parsed: (A * B * C) + D
As Optimized: A * B * C + D
Variables: (A, -1588), (B, -3513), (C, 838), (D, -2034)
Parsed Result: 22150
Optimized Result: 22150
```
...
Variables: (A, 9218), (B, -8149), (C, -915), (D, 5643), (E, 6182), (F, 2211), (G, -37), (H, 9028), (I, -3294)
Parsed Result: -8301
Optimized Result: -8301
```
...
Variables: (A, -415), (B, 386), (C, -2134), (D, 8378), (E, -4848), (F, 1366), (G, -4878), (H, 4703)
Parsed Result: -6086
...
As Parsed: (((A / B) * C * D) * E * F) + G
As Optimized: A / B * C * D * E * F + G
Variables: (A, -3344), (B, 4529), (C, 670), (D, -1630), (E, 343), (F, -4941), (G, 599)
Parsed Result: 599
Optimized Result: 599
```
...
As Optimized: (A + (-B)) / C * D * E * F * G + H
Variables: (A, 176), (B, -2352), (C, -9891), (D, 9212), (E, 830), (F, 5208), (G, -4314), (H, 5279)
Parsed Result: 5279
Optimized Result: 5279
```
...
Variables: (A, 1820), (B, 5760), (C, 3659), (D, -4), (E, -9246)
Parsed Result: 31106
Optimized Result: 31106
```
...
Variables: (A, 4968), (B, -3334), (C, -7799), (D, -5172), (E, 6405), (F, 1043), (G, -9441), (H, -811)
Parsed Result: -662
Optimized Result: -662
```
...
As Parsed: ((((A / B) * C) + D) * ((E * F) * G)) + H
As Optimized: (((A / B) * C) + D) * E * F * G + H
Variables: (A, 638), (B, -8923), (C, -3323), (D, -6229), (E, 2569), (F, -8908), (G, 8248), (H, -6242)
Parsed Result: -20034
Optimized Result: -20034
```
...
Variables: (A, 212), (B, 2832), (C, -284), (D, -9038), (E, -2636), (F, 1453), (G, 8692), (H, 3951)
Parsed Result: -22424
Optimized Result: -22424
```
...
Variables: (A, 628), (B, -4180), (C, 7407), (D, 761), (E, -3352), (F, -6636), (G, 8834), (H, -3759), (I, 609)
Parsed Result: 7494
Optimized Result: 7494
```
...
Variables: (A, -6932), (B, -7793), (C, 7529), (D, 7646), (E, -3684), (F, -7552)
Parsed Result: 5573
Optimized Result: 5573
```
...
As Parsed: ((A / (1 + (-1 * (B + C)))) * D) + E
As Optimized: A / (1 + (-(B + C))) * D + E
Variables: (A, -6539), (B, 7455), (C, 3353), (D, 750), (E, 5478)
Parsed Result: 5478
Optimized Result: 5478
```
...
As Parsed: (A / B) - (C + D + E + F)
As Optimized: A / B - C + D + E + F
Variables: (A, -5272), (B, 3811), (C, 5330), (D, -1390), (E, -8789), (F, -8240)
Parsed Result: 13088
Optimized Result: 13088
```
...
As Parsed: ((A / B) * C * D * E) + F
As Optimized: A / B * C * D * E + F
Variables: (A, -9499), (B, 2997), (C, 3767), (D, 2145), (E, 1138), (F, -8887)
Parsed Result: 8975
Optimized Result: 8975
```
...
Variables: (A, -3073), (B, -2736), (C, -8782), (D, -5152), (E, 2741), (F, 8308), (G, -7087)
Parsed Result: 27965
Optimized Result: 27965
```
...
As Parsed: (((A - (B * C)) / D) * E) + F
As Optimized: (A - (B * C)) / D * E + F
Variables: (A, -3358), (B, -5995), (C, 1907), (D, -59), (E, 4826), (F, -1285)
Parsed Result: -17921
Optimized Result: -17921
```
...
As Parsed: ((((A * B) + C) / D) * E) + F
As Optimized: ((A * B) + C) / D * E + F
Variables: (A, 8002), (B, 3279), (C, -9275), (D, -5690), (E, 3431), (F, 3449)
Parsed Result: -3413
Optimized Result: -3413
```
