...
‼21:              ['B'] = new[] { (byte)0xA2, (byte)0xE8 },
‼22:              ['C'] = new[] { (byte)0x88, (byte)0xBA },
‼23:              ['D'] = new[] { (byte)0xA8, (byte)0xE8 },
‼24:              ['E'] = new[] { (byte)0x8A, (byte)0x3A },
‼25:              ['F'] = new[] { (byte)0xA2, (byte)0x3A },
‼26:              ['G'] = new[] { (byte)0xAB, (byte)0x88 },
‼27:              ['H'] = new[] { (byte)0x8A, (byte)0xE2 },
‼28:              ['I'] = new[] { (byte)0xA2, (byte)0xE2 },
‼29:              ['J'] = new[] { (byte)0xA8, (byte)0xE2 },
‼30:              ['K'] = new[] { (byte)0x8A, (byte)0xB8 },
‼31:              ['L'] = new[] { (byte)0xA2, (byte)0xB8 },
‼32:              ['M'] = new[] { (byte)0x88, (byte)0xAE },
‼33:              ['N'] = new[] { (byte)0xA8, (byte)0xB8 },
‼34:              ['O'] = new[] { (byte)0x8A, (byte)0x2E },
‼35:              ['P'] = new[] { (byte)0xA2, (byte)0x2E },
‼36:              ['Q'] = new[] { (byte)0xAA, (byte)0x38 },
‼37:              ['R'] = new[] { (byte)0x8A, (byte)0x8E },
‼38:              ['S'] = new[] { (byte)0xA2, (byte)0x8E },
‼39:              ['T'] = new[] { (byte)0xA8, (byte)0x8E },
‼40:              ['U'] = new[] { (byte)0x8E, (byte)0xA8 },
‼41:              ['V'] = new[] { (byte)0xB8, (byte)0xA8 },
‼42:              ['W'] = new[] { (byte)0x8E, (byte)0x2A },
‼43:              ['X'] = new[] { (byte)0xBA, (byte)0x28 },
‼44:              ['Y'] = new[] { (byte)0x8E, (byte)0x8A },
‼45:              ['Z'] = new[] { (byte)0xB8, (byte)0x8A },
‼46:              ['0'] = new[] { (byte)0xAE, (byte)0x22 },
‼47:              ['1'] = new[] { (byte)0x8B, (byte)0xA8 },
‼48:              ['2'] = new[] { (byte)0xA3, (byte)0xA8 },
‼49:              ['3'] = new[] { (byte)0x88, (byte)0xEA },
‼50:              ['4'] = new[] { (byte)0xAE, (byte)0x28 },
‼51:              ['5'] = new[] { (byte)0x8B, (byte)0x8A },
‼52:              ['6'] = new[] { (byte)0xA3, (byte)0x8A },
‼53:              ['7'] = new[] { (byte)0xAE, (byte)0x88 },
‼54:              ['8'] = new[] { (byte)0x8B, (byte)0xA2 },
‼55:              ['9'] = new[] { (byte)0xA3, (byte)0xA2 },
‼56:              [' '] = new[] { (byte)0xB8, (byte)0xA2 },
‼57:              ['-'] = new[] { (byte)0xBA, (byte)0x88 },
‼58:              ['$'] = new[] { (byte)0xBB, (byte)0xBA },
‼59:              ['%'] = new[] { (byte)0xAE, (byte)0xEE },
‼60:              ['.'] = new[] { (byte)0x8E, (byte)0xA2 },
‼61:              ['/'] = new[] { (byte)0xBB, (byte)0xAE },
‼62:              ['+'] = new[] { (byte)0xBA, (byte)0xEE },
‼63:              ['*'] = new[] { (byte)0xBA, (byte)0x22 },
‼64:          };
〰65:  
