...
〰9:   {
‼10:      public static readonly DateTime UNIX_EPOCH = new(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
‼11:      public static readonly Base32Codec Base32Encoding = new();
〰12:  
...
‼77:          var secret = Convert.ToBase64String(buffer)[..10].Replace('/', '0').Replace('+', '1');
...
## File - https://raw.githubusercontent.com/mwwhited/BinaryDataDecoders/8fd359b8b3f932c5cfbd8436ce7fb9059d985101/src/BinaryDataDecoders.ToolKit/Security/Cryptography/OneTimeCode.cs
