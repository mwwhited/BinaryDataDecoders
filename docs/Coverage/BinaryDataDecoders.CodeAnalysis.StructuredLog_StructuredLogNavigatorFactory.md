...
## File - /home/runner/work/BinaryDataDecoders/BinaryDataDecoders/src/BinaryDataDecoders.CodeAnalysis.StructuredLog/StructuredLogNavigatorFactory.cs
...
‼51:                      (XName.Get(nameof(log.ShortenedName), ""), log.ShortenedName),
...
‼115:                     (XName.Get(nameof(log.TypeName), ""), log.TypeName),
...
‼135:                     (XName.Get(nameof(log.TypeName), ""), log.TypeName),
...
‼150:                     (XName.Get(nameof(log.TypeName), ""), log.TypeName),
